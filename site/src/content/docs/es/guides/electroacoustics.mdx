...
Los mismos paneles están disponibles de forma interactiva mediante `.plot()`,
que dibuja la hoja de características IEC 60268-5 (la respuesta en el eje ancha
sobre los paneles de impedancia, THD y polar) compartiendo su código de dibujo
con el informe, de modo que ambos nunca divergen. Al pasar unos ejes se dibuja
solo la respuesta en el eje.

```python
result.plot()   # hoja de características IEC 60268-5 multipanel (necesita matplotlib)
```

<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/loudspeaker_characteristics_es.svg" alt="Hoja de características del altavoz IEC 60268-5: una respuesta ancha del nivel de presión sonora en el eje con su banda de tolerancia sombreada y los marcadores del rango efectivo sobre un eje de frecuencias nominales, encima del módulo de impedancia con sus líneas nominal y del 80 % de la nominal, la distorsión armónica total frente a la frecuencia y la directividad polar sobre el círculo de referencia de 25 dB" width="92%" />
...
Los mismos paneles están disponibles de forma interactiva mediante `.plot()`,
que dibuja la hoja de características IEC 60268-4 (la respuesta de campo libre
ancha sobre los paneles polar, de ruido y de distorsión) compartiendo su código
de dibujo con el informe. Al pasar unos ejes se dibuja solo la respuesta de
campo libre.

```python
result.plot()   # hoja de características IEC 60268-4 multipanel (necesita matplotlib)
```

<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/microphone_characteristics_es.svg" alt="Hoja de características del micrófono IEC 60268-4: una respuesta relativa de campo libre ancha con su banda de tolerancia sombreada, el marcador de la frecuencia de referencia y los marcadores del rango efectivo sobre un eje de frecuencias nominales, encima del diagrama direccional cardioide sobre el círculo de referencia de 25 dB, el espectro de nivel de banda del ruido inherente y la distorsión armónica total frente al nivel de presión sonora con sus líneas de límite y de sobrecarga" width="92%" />
