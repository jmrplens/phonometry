...
res = building.vibration_reduction_index(
    dv, junction_length=4.0, area_i=12.0, area_j=10.0, frequencies=freqs,
...
res = building.vibration_reduction_index(dbar, lij, s_i, s_j, frequencies=freqs,
...
res_m = building.vibration_reduction_index(dbar, lij, s_i, s_j, frequencies=freqs,
