...
references:
  ...
  - type: book
    ...
    note: "La tabla de reflexión del extremo (§8.13), la pérdida por inserción de codos (§8.11), la reducción de un silenciador de láminas paralelas a conductos revestidos (§8.10.5, Ec. 8.241), la cámara plenum (§8.17) y el ruido generado por el flujo en conductos y codos (§8.15)."
  - type: report
...
Hansen y Howard para los silenciadores de láminas paralelas y los plenums. Los
...
**Silenciadores y plenums.** Un atenuador de láminas paralelas se reduce, en
el §8.10.5 de Bies, a un conjunto de conductos revestidos cuyo espesor de
revestimiento es la mitad del espesor de la lámina, combinados por la media
...
el panel de las láminas es el honrado: la regresión puramente geométrica no puede
...
revestimiento disipativo: la estimación del silenciador de láminas es una
