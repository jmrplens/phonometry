...
(20 µPa) — un desplazamiento de `20·lg(20) ≈ 26,02` dB, **no** una equivalencia
de energía/intensidad — usa `underwater_to_in_air_spl` /
...
procedures for description and measurement of underwater sound from ships*: el
nivel de ruido radiado, la geometría de tres hidrófonos en aguas profundas, la
incertidumbre tabulada del nivel de fuente y el nivel de fuente monopolar
equivalente mediante la corrección de superficie de Lloyd's mirror (Fórmula 3)
para una profundidad de fuente de `0,7·calado`. ISO 18406:2017, *Underwater
acoustics — Measurement of radiated underwater sound from percussive pile
driving*: la exposición sonora por golpe (Fórmulas 3–4), de pico y acumulada
