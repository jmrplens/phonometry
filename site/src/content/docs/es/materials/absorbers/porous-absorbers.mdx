...
dos probetas con las que calcula esta guía se publican en
`PUBLISHED_POROUS_MATERIALS`, cada una con la página de la que se leyó en su
`source`: la lana de vidrio «Domisol Coffrage» de la tabla 6.1 de Allard &
Atalla (p. impresa 124), cuyas longitudes características vienen impresas en el
texto de su apartado 6.5.4, en el folio de al lado, y la capa fibrosa blanda de
su tabla 11.2 (p. impresa 254). Son dos ejemplos resueltos y no un catálogo de
materiales: una probeta real se caracteriza según la ISO 9053 y la
ISO 10534-2, y todos los modelos de aquí mantienen sus parámetros como
