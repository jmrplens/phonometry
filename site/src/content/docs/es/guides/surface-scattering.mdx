...
La respuesta de un solo plano de abajo es un campo físico real: una simulación
propia en campo libre por elementos finitos (COMSOL) de un difusor de residuos
cuadráticos $N = 7$ y su panel de referencia plano a 1000 Hz, incidencia normal,
muestreada en el semicírculo estándar de 37 puntos (espaciado de 5°, de $-90°$ a
$+90°$) en el plano de máxima difusión, producida por el mantenedor (J. M.
Requena-Plens). Los niveles polares son $L_i = 20\,\lg|p_i|$; el coeficiente de
difusión se valida de forma cruzada frente a una implementación MATLAB
independiente de la Fórmula (5) de la ISO 17497-2, y los mismos valores
alimentan el conjunto de conformidad de phonometry.
