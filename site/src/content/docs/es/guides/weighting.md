...
Por defecto (`high_accuracy=True`), PyOctaveBand diseña y ejecuta el filtro de
...
Consulta [Procesado por bloques](/PyOctaveBand/es/guides/block-processing/) para
el flujo en streaming y [Teoría](/PyOctaveBand/es/reference/theory/) para las
