...
pages. Reducing it there is almost always cheaper than treating a path. At
...
- [Hydrodynamic Valve Noise (IEC 60534-8-4)](valve-cavitation.md):
  the same valve on a liquid line, where the jet's turbulence is one source
  and cavitation, past its threshold, is the other.
- [Room to Room: Partition, Receiving Room, Criterion](room-to-room.md):
