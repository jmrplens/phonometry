...
### PredictedScatteringSpectrum.from_printed()

*classmethod*

```python
PredictedScatteringSpectrum.from_printed(**cells: Any) -> Self
```
...
### PredictedScatteringSpectrum.printed_fields()

```python
PredictedScatteringSpectrum.printed_fields() -> dict[str, Any]
```
...
### PredictedScatteringSpectrum.values_at()
