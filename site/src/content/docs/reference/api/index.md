...
| [`vibration.structural.building_response`](/phonometry/reference/api/vibration/building-response/) | Predicting the fundamental frequency and damping of a building (ISO 4866). |
