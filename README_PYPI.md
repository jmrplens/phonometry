...
<a href="https://jmrplens.github.io/phonometry/"><img src="https://raw.githubusercontent.com/jmrplens/phonometry/v4.0.0rc1/.github/brand/banner.webp" alt="phonometry, acoustic measurement toolkit for Python" width="100%"></a>
...
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/LICENSE)
...
runs 1447 conformance checks across 97 domains and 477 standards, each pinning
...
banks are class 1 on every requirement the 2014 edition grades on a design.
Weightings and levels are class 1 per
**IEC 61672-1:2013**.

<a href="https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/CONFORMANCE.md"><img src="https://raw.githubusercontent.com/jmrplens/phonometry/v4.0.0rc1/.github/badges/conformance-summary.svg" alt="All 1447 conformance checks pass, across 97 domains and 477 standards"></a>
...
<img src="https://raw.githubusercontent.com/jmrplens/phonometry/v4.0.0rc1/.github/images/signal_response_fraction_3.svg" alt="One-third-octave spectrum analysis of a multi-tone signal with the raw PSD in the background" width="80%">
...
| `io` | Files. Measurement audio: every linear WAV a meter writes (PCM at any depth, EXTENSIBLE, RF64/BW64) read into a calibrated `Signal` with its `bext` provenance (EBU Tech 3285); headers-only `info()`; block streaming into the stateful filters; BWF writing with exact codes, loud clipping, optional TPDF dither and measured R 128 loudness; the calibration sidecar; lossless conversion to and from FLAC with provenance intact. Catalogues of materials of your own: a data sheet or a test report read from a JSON file or a spreadsheet saved as CSV, with its provenance, into the rows every published catalogue hands out, and written back |
...
<img src="https://raw.githubusercontent.com/jmrplens/phonometry/v4.0.0rc1/.github/images/filter_type_comparison.svg" alt="Magnitude response comparison of the five filter architectures for the 1 kHz octave band, with a zoom at the -3 dB crossover" width="80%">
...
[docs/](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/README.md);
a map of where to start:

| Area | Guides |
| :--- | :--- |
| Getting started | [Getting Started](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/start/getting-started.md) · [Build a sound level meter](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/signals/sound-level-meter.md) · [Calibration and dBFS](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/signals/metrology/calibration.md) |
| Filters, levels & weighting | [Filter Banks](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/signals/filters/filter-banks.md) · [Filter Gallery](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/signals/filters/filter-gallery.md) · [Levels](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/signals/levels/levels.md) · [Environmental Levels](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/environment/assessment/environmental-levels.md) · [Spanish Noise Regulation](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/environment/assessment/spanish-noise-regulation.md) · [Frequency Weighting](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/signals/levels/weighting.md) · [Special Weightings](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/signals/levels/special-weightings.md) · [Time Weighting](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/signals/levels/time-weighting.md) · [Block Processing](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/signals/filters/block-processing.md) · [Multichannel](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/signals/filters/multichannel.md) |
| Signal analysis | [Calibrated spectral analysis](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/signals/spectra/spectral-analysis.md) · [Correlation, time delay & envelope](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/signals/spectra/correlation-delay.md) · [Time-frequency analysis](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/signals/spectra/time-frequency.md) · [System measurement](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/signals/spectra/system-measurement.md) · [Measurement uncertainty](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/signals/metrology/gum-uncertainty.md) |
| Psychoacoustics & sound quality | [Loudness](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/perception/psychoacoustics/loudness.md) · [Advanced Loudness](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/perception/psychoacoustics/advanced-loudness.md) · [Sound Quality Metrics](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/perception/psychoacoustics/sound-quality.md) · [Tone Prominence](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/perception/psychoacoustics/tone-prominence.md) · [Psychoacoustic annoyance](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/perception/psychoacoustics/psychoacoustic-annoyance.md) |
| Speech & hearing | [Speech Transmission Index](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/perception/speech/speech-transmission.md) · [Speech Intelligibility Index](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/perception/speech/speech-intelligibility.md) · [Objective intelligibility](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/perception/speech/objective-intelligibility.md) · [Noise-induced hearing loss](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/perception/hearing/noise-induced-hearing-loss.md) · [Occupational exposure](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/perception/hearing/occupational-exposure.md) |
| Rooms & buildings | [Room Acoustics](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/buildings/rooms/room-acoustics.md) · [Field Insulation](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/buildings/insulation/insulation-field.md) · [Low-Frequency Procedure (ISO 16283)](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/buildings/insulation/low-frequency-procedure.md) · [Laboratory Insulation](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/buildings/insulation/insulation-lab.md) · [Predicting Insulation (EN 12354)](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/buildings/design/insulation-prediction.md) · [Image Sources](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/buildings/rooms/room-image-sources.md) · [Impulse Response (ISO 18233)](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/buildings/rooms/room-impulse-response.md) · [Open-Plan Offices](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/buildings/rooms/open-plan-acoustics.md) · [Insulation Ratings (ISO 717)](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/buildings/insulation/insulation-ratings.md) · [Façade Insulation](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/buildings/insulation/facade-insulation.md) · [Spanish Building Code (CTE DB-HR)](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/buildings/insulation/spanish-building-code.md) · [Survey Method (ISO 10052)](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/buildings/insulation/insulation-survey.md) · [Insulation by Intensity](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/buildings/insulation/insulation-intensity.md) · [Impact Improvement](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/buildings/design/impact-improvement.md) · [Flanking (ISO 10848)](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/buildings/insulation/flanking-lab.md) |
| Materials & surfaces | [Porous Absorbers](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/materials/absorbers/porous-absorbers.md) · [Metamaterial Absorbers](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/materials/absorbers/metamaterial-absorbers.md) · [Diffusers](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/materials/diffusers/diffusers.md) · [Metadiffusers](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/materials/diffusers/metadiffusers.md) · [Impedance Tube](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/materials/absorbers/impedance-tube.md) · [Absorption Measurement](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/materials/absorbers/absorption-measurement.md) · [Airflow Resistance](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/materials/absorbers/airflow-resistance.md) · [Road Absorption](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/materials/surfaces/road-absorption.md) |
| Environment & outdoors | [Outdoor Propagation](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/environment/propagation/outdoor-propagation.md) · [CNOSSOS-EU Road Emission](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/environment/sources/cnossos-road-emission.md) · [Ground & Barriers](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/environment/propagation/ground-barriers.md) · [Atmospheric Refraction](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/environment/propagation/atmospheric-refraction.md) |
| Transport | [Aircraft Noise](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/aircraft/aircraft-noise.md) · [Rotorcraft Noise](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/aircraft/rotorcraft-noise.md) · [Wind-Turbine Noise](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/environment/sources/wind-turbine-noise.md) · [Airport Noise](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/aircraft/airport-noise.md) |
| Underwater | [Underwater Acoustics](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/underwater/underwater-acoustics.md) · [Underwater Propagation](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/underwater/underwater-propagation.md) · [Underwater Solvers](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/underwater/underwater-solvers.md) · [Marine-Mammal Exposure](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/underwater/marine-mammal-exposure.md) |
| Vibration | [Human Vibration](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/vibration/human/human-vibration.md) · [Mechanical Mobility](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/vibration/structural/mechanical-mobility.md) · [Transfer Stiffness](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/vibration/structural/transfer-stiffness.md) |
| Electroacoustics & broadcast | [Electroacoustics](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/devices/electroacoustics/electroacoustics.md) · [Swept-Sine Distortion](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/devices/electroacoustics/swept-sine-distortion.md) · [Programme Loudness](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/devices/broadcast/program-loudness.md) · [Loudspeakers](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/devices/electroacoustics/loudspeakers.md) · [Microphones](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/devices/electroacoustics/microphones.md) |
| Emission | [Sound Power](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/devices/emission/sound-power.md) · [Sound Intensity](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/devices/emission/intensity.md) · [Sound Power by Pressure](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/devices/emission/sound-power-pressure.md) · [Reverberation Room](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/devices/emission/sound-power-reverberation.md) · [In Situ Comparison](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/devices/emission/sound-power-in-situ.md) · [By Intensity](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/devices/emission/sound-power-intensity.md) · [Silencers](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/devices/noise-control/silencers.md) · [Filter Compliance](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/signals/filters/filter-compliance.md) |
| Simulation | [2D FDTD Wave Simulation](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/simulation/fdtd-simulation.md) · [Elastic Waves](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/simulation/elastic-waves.md) |
| Reference | [API Reference](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/reference/api/index.md) · [Theory](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/reference/theory/index.md) · [Bibliography](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/reference/bibliography.md) · [Why phonometry](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/start/why-phonometry.md) · [Conformance report](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/CONFORMANCE.md) · [Standards errata](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/docs/ERRATA.md) |
...
[`CITATION.cff`](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/CITATION.cff),
...
See the
[contributing guide](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/CONTRIBUTING.md)
and the
[changelog](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/CHANGELOG.md).
...
as set out in the
[security policy](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/SECURITY.md).

## 📄 License

[MIT](https://github.com/jmrplens/phonometry/blob/v4.0.0rc1/LICENSE)
