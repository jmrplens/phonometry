...
pie con el descargo de responsabilidad fijo. El recuadro NC muestra `NC-nn` con
su banda determinante; el recuadro RC muestra `RC-nn(etiqueta)` con la media de
