...
- [Verifying a vibration meter](vibration/human/meter-verification.md): the ISO 8041-1:2017 tolerances on the frequency weightings, with the four transition frequencies of Table 4, the four tolerance regions of Table 5, the reference conditions of Table 1 and the indication tolerance of Table 2, giving a vibration meter the kind of verdict IEC 61672-1 gives a sound level meter
