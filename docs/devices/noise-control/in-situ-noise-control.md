...
as a quarter of the Sabine equivalent absorption area.
...
edge on a vertical plane through it, or the elevation rule of the NOTE for a
source region closer than 15 m. Record the wind component, the temperature and
...
inequality of clause 4 may be stated.
...
test, microphone geometry and impulse rule of ISO 11821; and the direct and
