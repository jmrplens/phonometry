---
title: "Predicting railway vibration (E DIN 45672-3)"
description: "What a building next to a railway will feel before either exists: the additive chain of E DIN 45672-3 from an emission spectrum through the ground and the building to a third-octave spectrum on a floor, the six transfer tables of Annex A, the KB values of DIN 4150-2 formed from the spectrum, and the Annex C example with what its print gets wrong."
references:
  - type: standard
...
[DIN 45672-1](/phonometry/vibration/immission/railway-vibration/) measures
...
numbers [DIN 4150-2](/phonometry/vibration/immission/people-in-buildings/)
judges.
...
weighting of [DIN 45669-1](/phonometry/vibration/immission/vibration-meter/)
...
the peak velocity a [DIN 4150-3](/phonometry/vibration/structural/structural-damage/)
...
the sum of Formula (6) of the [draft of DIN 4150-2](/phonometry/vibration/immission/railway-categories/)
...
[errata page](/phonometry/reference/errata/) has the readings, together with
...
- API reference:
  [`vibration.immission.railway_prediction`](/phonometry/reference/api/vibration/railway-prediction/).
