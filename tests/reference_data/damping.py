...
VER_BERANEK_14_1: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    (
        "blachford Aquaplas",
        ("0.5", "50", "80", "125", "1.6e6", "3e4", "2.2e5", "1.1e5"),
    ),
    (
        "Barry Controls H-326",
        ("0.8", "−40", "−25", "−10", "6e5", "3e3", "4.2e4", "3.4e4"),
    ),
    (
        "Dow Corning Sylgard 188",
        ("0.6", "60", "80", "110", "2.2e4", "3e2", "2.6e3", "1.5e3"),
    ),
    ...
    (
        "Soundcoat DYAD 609",
        ("1.0", "125", "150", "185", "2e5", "6e2", "1.1e4", "1.1e4"),
    ),
