...
def _airborne_example() -> tuple[object, ReportMetadata, str]:
    ...
    metadata = ReportMetadata(
        ...
        source_temperature_c=21.6,
        source_relative_humidity_percent=35.3,
        receiving_temperature_c=20.9,
        receiving_relative_humidity_percent=37.4,
        static_pressure_kpa=101.9,
...
def _impact_example() -> tuple[object, ReportMetadata, str]:
    ...
    metadata = ReportMetadata(
        ...
        source_volume=53.0,
        receiving_volume=51.0,
        source_temperature_c=20.8,
        source_relative_humidity_percent=47.0,
        receiving_temperature_c=20.5,
        receiving_relative_humidity_percent=48.0,
        static_pressure_kpa=100.9,
        test_room="Transmission suite (example)",
...
def _lab_airborne_example() -> tuple[object, ReportMetadata, str]:
    ...
    metadata = ReportMetadata(
        ...
        source_volume=53.0,
        receiving_temperature_c=20.8,
        receiving_relative_humidity_percent=46.0,
...
def _lab_impact_example() -> tuple[object, ReportMetadata, str]:
    ...
    metadata = ReportMetadata(
        ...
        mass_per_area=336.0,
        receiving_volume=50.0,
        receiving_temperature_c=20.6,
        receiving_relative_humidity_percent=45.0,
        test_room="Transmission suite (example)",
