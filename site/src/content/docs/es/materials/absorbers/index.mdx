...
pequeña en un tubo de impedancia. El banco de flujo se presenta antes que el
tubo porque la resistividad que mide es el único parámetro del que parte todo
modelo contra el que se ajusta el tubo. Después vienen los modelos de
predicción que atan las tres escalas, y los diseños de metamaterial que las
llevan más allá de las reglas clásicas de espesor.
...
[Techos suspendidos: el código de ensayo
EN 16487](/phonometry/es/materials/absorbers/suspended-ceilings/)
es lo que esa escala de producto necesita para ser reproducible en una familia
concreta: el tamaño de la muestra, el montaje y la profundidad de plenum con la
que se mide un techo, la corrección por absorción del aire por debajo de la cual
tiene que quedarse la sala, y la reproducibilidad entre laboratorios que compra
seguir todo eso.
...
- [Techos suspendidos: el código de ensayo EN 16487](/phonometry/es/materials/absorbers/suspended-ceilings/):
  la geometría de la muestra, la profundidad del montaje de tipo E, el tope de
  absorción del aire y la tabla 1, la reproducibilidad entre laboratorios
  europeos.
