---
title: "Transmisión de onda de flexión en uniones de placas (Cremer / Craik / Hopkins)"
...
`Kij = 10 lg(1 / tau_ij) + 5 lg(fc_j / fc_i)`, que para placas idénticas se
reduce a `Kij = 10 lg(1 / tau_ij)` -- para la unión en X idéntica,
`10 lg 12 ~= 10.8 dB`.
