...
print(res.passes)                                         # False (la deriva supera el 5 %)
res.plot()
```
...
describen aquí y se dejan al operador, igual que el ensayo de linealidad de la
ISO 10846 (apartado 7.7 de las Partes 2, 4 y 5, apartado 7.6 de la Parte 3) se
describe pero no se calcula en la [página de rigidez de
