...
references:
  ...
  - type: standard
    ...
    note: "Los 20 µPa de la Tabla 1 y el 1 µPa de la Tabla 2 entre los que la sección 1 re-referencia un nivel, y la nota b de la Tabla 2, los 26,0 dB entre ellos; publicados como metrology.ISO1683_REFERENCE_VALUES. Leída en la adopción española UNE-EN ISO 1683:2016."
  - type: standard
    organization: "International Organization for Standardization"
    year: 2016
...
Las dos referencias son presiones acústicas de la ISO 1683:2015, los 20 µPa de
la Tabla 1 para los gases y el 1 µPa de la Tabla 2 para los líquidos, y la
nota b de la Tabla 2 imprime el salto entre ellas como aproximadamente 26,0 dB.
La biblioteca las publica, con el resto de los valores de referencia de esa
norma, como `metrology.ISO1683_REFERENCE_VALUES`; la
[guía de niveles](/phonometry/es/signals/levels/levels/#desde-qué-valor-de-referencia-se-cuenta-cada-nivel)
las recoge todas.
