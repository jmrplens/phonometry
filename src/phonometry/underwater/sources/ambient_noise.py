...
#: ``20·lg(20) ≈ 26.02`` dB, the step between the two pressures of
#: ISO 1683:2015 Tables 1 and 2 (note b of Table 2).
_WIND_ANCHOR_DB = 25.0 + 20.0 * np.log10(
    ISO1683_REFERENCE_VALUES["gas"]["sound_pressure"].value / _P_REF
)
