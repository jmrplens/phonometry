...
ratio of the second- to the first-order coefficient of its equation of state,
which sets how fast a wave steepens towards a shock and how strongly two beams
mix. A hundred and sixty-four published values from the four tables of one
