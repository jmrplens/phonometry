...
no atiende a lo que radia un edificio, sino a si se agrieta: los valores de
referencia de la velocidad de pico de la partícula que pueden llegar a un
cimiento, al plano de la última planta o a una tubería enterrada, según el tipo
de edificio y según con qué frecuencia se repite la vibración.
