...
references:
  - type: book
    ...
    note: "ISBN 978-0-419-19810-9. La monografía sobre el flujo de energía sonora: por qué la intensidad separa la energía que sale de la fuente de la energía estacionaria que solo pasa, detrás de los métodos de barrido de las secciones 3 y 5."
  - type: book
  ...
  - type: standard
    ...
    note: "La guía de selección detrás de 'Elegir un método': grados, entornos y criterios de tamaño de fuente y de ruido de fondo para toda la familia."
  - type: standard
    organization: "International Organization for Standardization"
    year: 2010
...
<Video
  ...
  width={2400}
  height={1350}
  title="La misma fuente, dos salas, una potencia sonora"
  description="La misma fuente en una cámara anecoica y en una cámara reverberante produce presiones de micrófono distintas, y las fórmulas de campo libre y campo difuso convergen al mismo nivel de potencia sonora L_W."
/>
...
<Video
  ...
  description="Una sonda p-p recorre el barrido en serpentina sobre la cara superior de la caja de medición mientras aparecen detrás las flechas de intensidad normal, y las potencias parciales de las cinco caras se acumulan en el nivel de potencia sonora L_W."
/>
