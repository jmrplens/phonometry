...
- **Alcance en frecuencia.** Una cámara o un resonador reactivo es más fuerte
  ...
  las geometrías de láminas paralelas (pasos estrechos, más perímetro revestido
  por unidad de superficie) siguen funcionando. La UNE-EN ISO 7235:2010 admite
  «divisores» como sinónimo de «láminas paralelas» en la NOTA 2 de su apartado
  3.19.
...
láminas, que estrecha el paso y multiplica el perímetro revestido, mantiene 30 dB
...
silenciador in situ, donde el truco de la sustitución suele ser imposible. La
aritmética de las dos primeras, la resta misma y las tablas que la acompañan,
está en [Medir un
silenciador](/phonometry/es/devices/noise-control/silencer-measurement/).
...
se usan aquí. Nada de lo que hay en esta página es una medición: la aritmética
de la ISO 7235 tiene [página
propia](/phonometry/es/devices/noise-control/silencer-measurement/), no se
modelan ni la radiación por la envolvente ni las correcciones de extremo de los
saltos de área, y los modelos de rama no tienen pérdidas salvo que se dé una
`resistance`.
</ScopeClaim>
</Scope>
