...
kin.airspeed, kin.path_angle_deg          # seleccionan el hemisferio por punto
kin.bank_angle_deg                        # inclina el hemisferio en virajes
...
suavizados por punto de `airspeed`, `path_angle_deg`, `heading` y `bank_angle_deg` de un
