...
<Scope>
<ScopeClaim status="covered" label="the clauses that are arithmetic">
...
verification](/phonometry/vibration/human/meter-verification/) page: the
...
of [DIN 4150-3](/phonometry/vibration/structural/structural-damage/) are a
