...
- [Medir un silenciador (ISO 7235 e ISO 11691)](/phonometry/es/devices/noise-control/silencer-measurement/):
  de dónde sale la pérdida por inserción de un catálogo, y cuán repetible es.
- [Encapsulados y cabinas medidos (ISO 11546, ISO 11957)](/phonometry/es/devices/noise-control/enclosure-cabin-insulation/):
  lo que vale un encapsulado construido en vez de lo que se diseñó para valer,
  y la cabina, que es el mismo problema al revés.
- [Silenciadores, pantallas y barreras in situ](/phonometry/es/devices/noise-control/in-situ-noise-control/):
  el silenciador en el conducto al que se montó, la pantalla que se puede
  apartar, y la barrera que se construyó hace años.
...
- [Ruido hidrodinámico de válvulas (IEC 60534-8-4)](/phonometry/es/devices/noise-control/valve-cavitation/):
  la misma válvula en una línea de líquido, donde la turbulencia del chorro es
  una fuente y la cavitación, pasado su umbral, es la otra.
