...
- [Rotorcraft noise: the hemisphere method](rotorcraft-noise.md) — the ECAC Doc 32 / NORAH2 helicopter noise hemisphere source model and its propagation adjustments: spherical spreading, atmospheric absorption (ISO 9613-1 / Table 4) and the Chien-Soroka ground effect over CNOSSOS impedance ground
