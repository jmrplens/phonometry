...
The parameters the equivalent-fluid and poroelastic models take, from three
books, and they are two kinds of row. A specimen row is one sample somebody
measured, with every parameter a model needs beside it, and it is the input to
