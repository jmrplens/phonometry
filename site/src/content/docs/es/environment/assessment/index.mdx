...
description: "Evaluar el ruido ambiental una vez ha llegado: los indicadores y el nivel de evaluación de ISO 1996-1, la cadena de determinación de ISO 1996-2 con su corrección de ruido residual y su balance de incertidumbre, el ajuste por sonidos impulsivos, la distribución estadística del nivel de exposición sonora de una voladura, una aplicación nacional de toda la cadena, y el análisis del paisaje sonoro de ISO/TS 12913, que pregunta cómo lo oye la gente que está allí."
---
...
es para la fuente cuyo nivel en el receptor no es un solo número: una
voladura o un disparo a kilómetros, que se oye diez decibelios más o menos
según cambia el tiempo atmosférico entre ambos. A partir del nivel y la
probabilidad de cada atmósfera réplica construye la distribución estadística
del nivel de exposición sonora del suceso, la dispersa por turbulencia y lee
el nivel a largo plazo, el nivel de evaluación con el ajuste impulsivo K y el
nivel superado por cualquier porcentaje de los sucesos.

[Análisis del paisaje sonoro (ISO/TS 12913)](/phonometry/es/environment/assessment/soundscape/)
da la vuelta a la pregunta: no cuánto sonido llega, sino cómo lo oye la gente
que está allí. Su entrada es un cuestionario y no una señal: los valores de
escala y las medianas por lugar del cuestionario de ISO/TS 12913-2, la
agradabilidad y la eventualidad de cada lugar en el modelo de dos dimensiones
de ISO/TS 12913-3, las correlaciones que enlazan las respuestas con los niveles
medidos y el análisis binaural del mismo lugar en los dos oídos.
...
nacional de ambas. La página de la exposición sonora de sucesos impulsivos
queda a su lado para campos de tiro, canteras y demoliciones, donde el tiempo
atmosférico decide el nivel, y la del paisaje sonoro para un estudio que
pregunta a la gente que convive con el sonido.
...
- [Exposición sonora de sucesos impulsivos (ISO 13474)](/phonometry/es/environment/assessment/sel-distribution/):
  los niveles a largo plazo y de evaluación de una voladura a partir de sus
  atmósferas réplica, las clases ordenadas y sus densidades, la dispersión por
...
- [Análisis del paisaje sonoro (ISO/TS 12913)](/phonometry/es/environment/assessment/soundscape/):
  el cuestionario y sus valores de escala, la agradabilidad y la eventualidad
  de la Figura A.1, las correlaciones de Spearman y de Pearson, los
  estadísticos del Método B, las métricas binaurales de la Tabla D.1 y el
