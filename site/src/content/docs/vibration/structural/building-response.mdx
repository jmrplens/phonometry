...
references:
  - type: standard
    ...
    primary: true
    note: "Annex D: the storey rule and the three code forms of D.2 with their coefficient ranges, the f = 46/h fit D.2 closes with and the ± 50 % accuracy it admits, and the measured damping values of D.4. The building and foundation classification of Annex B and the response ranges of Annex A are described here and not implemented."
---
