...
reverberación de medias objetivo mediante `requirement` (leído como el
$T_\text{mid}$ máximo aceptable, la forma habitual de un límite de aula u
oficina diáfana). Usa el mismo contenedor `ReportMetadata` y el mismo motor de
renderizado que la
