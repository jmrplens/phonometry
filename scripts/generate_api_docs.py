...
_API_CHIPS: dict[str, tuple[str, str]] = {
    # Filters and frequencies ("phonometry" top level is package metadata: no chip)
    ...
    "phonometry.metrology.compliance": ("IEC 61260", "s"),
    # Levels and calibration
    "phonometry.metrology.levels": ("IEC 61672", "s"),
    "phonometry.metrology.calibration": ("IEC 60942", "s"),
    # Psychoacoustics
    "phonometry.psychoacoustics.loudness_zwicker": ("ISO 532-1", "s"),
    "phonometry.psychoacoustics.loudness_moore_glasberg": ("ISO 532-2", "s"),
    "phonometry.psychoacoustics.loudness_moore_glasberg_time": ("ISO 532-3", "s"),
    ...
    # Speech
    "phonometry.hearing.sti": ("IEC 60268-16", "s"),
    "phonometry.hearing.sii": ("ANSI S3.5", "s"),
    "phonometry.hearing.objective_intelligibility": ("Taal et al. 2011", "t"),
    # Hearing and exposure
    "phonometry.hearing.threshold": ("ISO 7029", "s"),
    "phonometry.hearing.noise_induced_hearing_loss": ("ISO 1999", "s"),
    "phonometry.hearing.occupational_exposure": ("ISO 9612", "s"),
    # Room acoustics
    "phonometry.room.room_acoustics": ("ISO 3382", "s"),
    "phonometry.room.room_ir": ("ISO 18233", "s"),
    "phonometry.room.room_noise": ("ANSI S12.2", "s"),
    "phonometry.room.open_plan": ("ISO 3382-3", "s"),
    "phonometry.room.reverberation_prediction": ("Sabine / Eyring", "t"),
    "phonometry.room.enclosed_space_absorption": ("EN 12354-6", "s"),
    "phonometry.room.image_source": ("Kuttruff", "t"),
    "phonometry.room.steady_field": ("Kuttruff", "t"),
    # Building acoustics
    "phonometry.building.insulation": ("ISO 16283 / 717", "s"),
    ...
    "phonometry.materials.impedance_tube": ("ISO 10534", "s"),
    "phonometry.materials.porous_absorber": ("Mechel", "t"),
    "phonometry.materials.scattering_diffusion": ("ISO 17497", "s"),
    ...
    "phonometry.vibration.radiation_efficiency": ("ISO/TS 7849", "s"),
    "phonometry.vibration.junction_transmission": ("Cremer & Heckl", "t"),
    "phonometry.vibration.transfer_stiffness": ("ISO 10846", "s"),
    "phonometry.vibration.human_vibration": ("ISO 2631 / 5349", "s"),
    "phonometry.vibration.multiple_shock_vibration": ("ISO 2631-5", "s"),
    # Environmental acoustics
    "phonometry.environmental.outdoor_propagation": ("ISO 9613", "s"),
    "phonometry.environmental.ground_barriers": ("ISO 9613-2", "s"),
    ...
    "phonometry.aircraft.aircraft_noise": ("ICAO Annex 16", "s"),
    ...
    "phonometry.aircraft.rotorcraft_noise": ("Olsen et al.", "t"),
    "phonometry.environmental.wind_turbine_noise": ("IEC 61400-11", "s"),
    ...
    "phonometry.noise_control.silencers": ("Bies & Hansen", "t"),
    "phonometry.noise_control.hvac": ("Bies & Hansen", "t"),
    "phonometry.noise_control.enclosures": ("Bies & Hansen", "t"),
    # Program loudness
    "phonometry.broadcast.program_loudness": ("EBU R 128", "s"),
    # Uncertainty and data quality
    "phonometry.metrology.uncertainty": ("JCGM 100", "s"),
    "phonometry.metrology.random_data": ("Bendat & Piersol", "t"),
    # Spectral analysis
    "phonometry.metrology.spectra": ("Welch 1967", "t"),
    ...
    "phonometry.metrology.cepstrum": ("Havelock et al.", "t"),
    "phonometry.metrology.synchronous_average": ("McFadden 1987", "t"),
    "phonometry.metrology.inversion": ("Farina 2000", "t"),
    # Wave simulation
    "phonometry.simulation.fdtd": ("Botteldooren 1995", "t"),
    # Correlation and envelope
    "phonometry.metrology.correlation": ("Bendat & Piersol", "t"),
...
def render_sidebar(pages: list[ModuleDoc]) -> str:
    ...
    def item(page: ModuleDoc) -> str:
        ...
        chip = _API_CHIPS.get(page.module)
        if chip is None:
            return f"        {js(slug)},"
        text, kind = chip
        cls = "chip-standard" if kind == "s" else "chip-theory"
        return (
            f"        {{ slug: {js(slug)}, "
            f"badge: {{ text: {js(text)}, class: {js(cls)} }} }},"
        )
