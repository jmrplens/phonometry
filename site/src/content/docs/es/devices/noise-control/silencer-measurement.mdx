...
$\theta + 273\ ^\circ\text{C}$, y ninguna de las dos es la cifra exacta.
Juntas dejan la densidad un 0,069 % alta a 20 °C, y la biblioteca conserva
ambas tal como vienen impresas, porque el error se cancela: la misma densidad
aparece en la presión dinámica de las dos series de ensayo, de modo que el
coeficiente nunca la ve. Queda registrado en el [registro de
...
Ese número pertenece al objeto y no al punto de ensayo: una pérdida crece con
el cuadrado de la velocidad y la altura por la que se divide también, así que
medir el mismo objeto al doble de velocidad da el mismo coeficiente.
...
promedio siga siendo una medida. Con menos de cinco, la biblioteca lo dice.
