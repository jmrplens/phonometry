...
- [Underwater sound propagation](underwater-propagation.md) — closed-form transmission loss (geometrical spreading plus volume absorption by Francois-Garrison, Ainslie-McColm or Thorp), the speed of sound in sea water (UNESCO/Chen-Millero, Del Grosso, Mackenzie) with the sound-speed profile, and the passive/active sonar equation
- [Aircraft noise: Effective Perceived Noise Level](aircraft-noise.md) — the ICAO Annex 16 Vol. I Appendix 2 EPNL (perceived noisiness and PNL, the tone correction by the slope method, and the 10 dB-down duration correction) and the IEC 61265 measurement-system verifier
