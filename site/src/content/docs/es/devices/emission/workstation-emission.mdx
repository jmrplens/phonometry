...
references:
  ...
  - type: standard
    ...
    note: "La ruta que no mide nada: L_p = L_W - Q, con Q la única expresión impresa que el documento lleva."
---
...
lo que $K_3 = K_2$ exactamente: un puesto que no ve la máquina con más fuerza
que la superficie de medida necesita justo la corrección que necesitaba la
superficie.
