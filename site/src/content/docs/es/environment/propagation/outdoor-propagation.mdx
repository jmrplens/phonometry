...
| `temperature_c` | float | °C | def. `20.0` | −20…+50 tabulado; fuera avisa |
| `relative_humidity_percent` | float | % | def. `50.0` | 10…100 tabulado; se admite `[0, 100]` |
| `atmospheric_pressure_kpa` | float | kPa | def. `101.325` | ≤ 200 válido (apartado 7); por encima avisa |
...
| `temperature_c` / `relative_humidity_percent` / `atmospheric_pressure_kpa` | float | °C / % / kPa | 20 / 70 / 101.325 | Pasados a $A_\mathrm{atm}$ |
