...
| Rodino & Masson (2015) Tabla 2, printed folio 7 (PDF page 7) | Six printed insertion losses of a screen measured with no reference microphone, where 8.2.1 degenerates to the plain level difference | 6/6 (worst departure 0.000 dB) | 6/6 printed insertion losses, unweighted and A-weighted | exact | 0 % | ![Pass][cv-pass] Pass |
