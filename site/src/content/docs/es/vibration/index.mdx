...
<Scope>
<ScopeClaim status="covered" label="solo la ponderación frecuencial">
**Un instrumento se juzga por su ponderación y por nada más.** Las tablas de
tolerancia de la ISO 8041-1 están implementadas, así que una respuesta de
ponderación medida puede contrastarse con la banda que la norma le permite, en
la página de [verificación del
vibrómetro](/phonometry/es/vibration/human/meter-verification/). El resto de
