...
El `residual` (entrada menos la reconstrucción periódica sobre el tramo
analizado) y su `residual_rms` cuantifican lo que queda una vez eliminada la
componente síncrona, que es el ruido que el promediado aún no ha suprimido.
