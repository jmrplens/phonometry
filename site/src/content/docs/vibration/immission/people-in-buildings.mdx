...
references:
  ...
  - type: standard
    ...
    note: "The meter whose KB_Fmax and clock maxima this standard assesses, and the corner frequency of 5,6 Hz that Formula (6) carries. The three simultaneous channels and the fourth near the source of 5.1.2, the interruption and back-erasure of the clock maxima of 5.1.6.4, and the check before a measurement of 6.5."
  - type: standard
    organization: "Deutsches Institut für Normung"
    year: 2005
    title: "Messung von Schwingungsimmissionen — Teil 2: Messverfahren"
    designation: "DIN 45669-2:2005-06"
    note: "The measurement section: the floor positions of 5.1.3, the directions of 5.2, the couplings of 5.3.2 and 5.3.3 with Table 1, the measuring time of 6.1, the disturbances of 7.2.2 and the report of Clause 9. The loose-mounting limits, the wax limit and the mass loading are implemented on the meter's page; the rest is text."
---
...
the changes have
[their own page](/phonometry/vibration/immission/railway-categories/).
