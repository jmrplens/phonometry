...
semicircle (5° spacing, $-90°$ to $+90°$) in the plane of maximum diffusion,
from J. M. Requena-Plens, *Estudio y caracterizacion de difusores acusticos
mediante el metodo de los elementos finitos* (MSc thesis, Universitat
Politecnica de Valencia, 2018). The polar levels are $L_i = 20\,\lg|p_i|$ from
the published far-field prediction; the same values drive the phonometry
conformance suite.
