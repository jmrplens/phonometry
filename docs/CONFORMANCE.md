...
| ISO 11690-3:1998 Annex B, Figure B.1 against Tables B.5 and B.8 (BS EN printing, printed folios 16 and 18) | The results of Annex B belong to the positions Figure B.1 draws, and not to the ones the two workstation tables put the same labels on | 6/6, against 0/6 at the positions Tables B.5 and B.8 tabulate, which are between 0,5 dB and 1,8 dB out | 6/6 printed cells reproduced at the position Figure B.1 draws | exact | 0 % | ![Pass][cv-pass] Pass |
