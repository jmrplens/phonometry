...
<ThemeImage
  src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/diagram_valve_noise_place.svg"
  alt="Sección de una válvula de control sobre una tubería. El flujo entra por la izquierda, el cuerpo de la válvula abraza el tubo con su obturador cerrando sobre un asiento, y la vena se estrangula en la vena contracta justo aguas abajo del obturador, marcada como la fuente. Desde ahí un chorro en forma de cuña se abre aguas abajo dentro del tubo. Una flecha sale de la pared del tubo y sube hasta un micrófono, señalada como la salida por la pared, y el micrófono está acotado a 1 m aguas abajo del cuerpo de la válvula y a 1 m de la pared exterior, que es donde se declara el nivel ponderado A L p A e 1 m. Más aguas abajo, una flecha señala el tubo para decir que una salida rápida es una segunda fuente que se suma en energía a la primera. Debajo, una nota que dice que el cuerpo no es el camino y la válvula no es la fuente: el ruido se hace donde la vena se estrangula, y la pared decide cuánto se oye."
  width="100%"
/>
