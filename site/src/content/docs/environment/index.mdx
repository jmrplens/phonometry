...
description: "Sound outdoors and the sources that dominate it: the ISO 9613 propagation model, the ISO 1996 rating level and its Spanish application, the NT ACOU 112 impulsive-sound adjustment, the CNOSSOS-EU road and railway and IEC 61400-11 wind-turbine source models, and the ISO 11819-1 statistical pass-by that rates a road surface."
---
