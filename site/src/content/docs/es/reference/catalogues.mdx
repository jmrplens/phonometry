...
Los parámetros que toman los modelos de fluido equivalente y poroelásticos, de
tres libros, y son dos clases de fila. Una fila de espécimen es una probeta que
alguien midió, con todos los parámetros que pide un modelo al lado, y es la
