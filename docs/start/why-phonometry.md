...
| IEC 60942:2017 Tables 2 to 7, A.1 to A.5 and E.1 | Calibrator short-term stability limits by class and frequency in `sensitivity()`, and every requirement graded by `verify_sound_calibrator()` | `tests/metrology/test_calibration_validation.py`, `tests/metrology/test_sound_calibrator.py` |
