...
actuar. Cuatro páginas la cubren: la cadena general, el caso especial que la
rompe, lo que un asiento hace con la vibración que transmite, y si el
instrumento que mide tiene derecho a que se le crea.
...
- [Verificación del vibrómetro de vibración en humanos (ISO 8041-1)](/phonometry/es/vibration/human/meter-verification/):
  la banda de tolerancia alrededor de cada ponderación frecuencial, la
  desviación característica de fase, el decaimiento del valor eficaz móvil y las
...
**Un vibrómetro se juzga por los apartados que se pueden calcular.** Las tablas
de tolerancia de la ISO 8041-1 están implementadas, y también todo otro
criterio suyo que sea pura aritmética: la etapa de limitación de banda por separado,
la desviación característica de fase, los tiempos de decaimiento del valor
eficaz móvil y las 228 indicaciones de la ráfaga en diente de sierra que la
norma imprime, que es de lo que trata la [verificación
del vibrómetro](/phonometry/es/vibration/human/meter-verification/). Los
apartados de diseño y ensayo de tipo de esa norma, desde la indicación y la
linealidad hasta los ensayos ambientales, son medidas de laboratorio sobre
hardware y quedan fuera: cumplir en cualquiera de ellos es condición
necesaria para la conformidad, no un certificado de ella.
</ScopeClaim>
