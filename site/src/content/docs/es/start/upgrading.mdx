...
| Antes | 4.0 |
| --- | --- |
| `overall_class` 1 para el banco de octavas diezmado (Butterworth, orden 6, 48 kHz) | 2: sus salidas adyacentes suman hasta +0,94 dB respecto a la entrada, más allá de los +0,8 dB de la clase 1 en el 5.16; el mismo banco diseñado con `FilterDesign(resample=False)` es clase 1 |
...
El banco de tercios de octava sigue siendo clase 1.
...
puso la unidad en la etiqueta; salvo ese veredicto, no recalculó nada.
