...
página y dicen cómo llegó ahí: un valor que la página imprime en otra unidad,
grados Fahrenheit, psi o sabinios, está convertido, y la marca da la cifra y la
unidad que imprime; y una celda que la página deja en blanco porque imprime el
valor una sola vez para un bloque de filas está arrastrada, y la marca nombra
la fila que lo imprime. Un valor que la propia fuente llama estimación va
marcado como tal.
