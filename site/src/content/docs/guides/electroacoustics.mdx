...
references:
  ...
  - type: standard
    ...
    note: "Clause 11 (sensitivity and sensitivity level): the microphone conventions of section 5, cited for context rather than implemented as code."
  - type: standard
    organization: "International Electrotechnical Commission"
    year: 2003
    ...
    note: "Clauses 7.1, 20.3 and 20.4 (measurement distance, characteristic sensitivity and its level): the loudspeaker conventions of section 5, cited for context rather than implemented as code."
---
...
- API reference: [`electroacoustics.distortion`](/phonometry/reference/api/electroacoustics/distortion/), [`electroacoustics.frequency_response`](/phonometry/reference/api/electroacoustics/frequency-response/) and [`electroacoustics.piston`](/phonometry/reference/api/electroacoustics/piston/).
