...
- **Daño**: [Pérdida auditiva inducida por ruido (ISO 1999)](/phonometry/es/perception/hearing/noise-induced-hearing-loss/):
  ...
  HTLAN.
- **Protección**: [Protectores auditivos (ISO 4869-1, -2 y -6)](/phonometry/es/perception/hearing/hearing-protectors/):
  ...
  un protector deja realmente en el oído, y lo que añade una orejera de
  reducción activa.
