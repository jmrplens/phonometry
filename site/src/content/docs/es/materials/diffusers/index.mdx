...
- [Superficies medidas in situ](/phonometry/es/materials/surfaces/) y su guía
  ...
  ISO 13472-2.
- [Catálogos publicados](/phonometry/es/reference/catalogues/#coeficientes-de-dispersión): los
  coeficientes de dispersión y de difusión, medidos y calculados, de los
  apéndices, superficie a superficie.
