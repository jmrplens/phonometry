...
_STRINGS: dict[str, str] = {
    ...
    "L<sub>W</sub> = L<sub>v</sub> + 10 lg(S/S<sub>0</sub>) + 10 lg(&#949;) + 10 lg(Z<sub>c,n</sub>/Z<sub>c,0</sub>), S<sub>0</sub> = 1 m<super>2</super> (ISO/TS 7849-1:2009 Eq. 12, -2:2009 Eq. 15), with the surface velocity level L<sub>v</sub> = 20 lg(v/v<sub>0</sub>), v<sub>0</sub> = 5&#183;10<super>&#8722;8</super> m/s (Eq. 3) and the fixed impedance term 10 lg(Z<sub>c,n</sub>/Z<sub>c,0</sub>) = 10 lg(411/400) = 0,12 dB.": "L<sub>W</sub> = L<sub>v</sub> + 10 lg(S/S<sub>0</sub>) + 10 lg(&#949;) + 10 lg(Z<sub>c,n</sub>/Z<sub>c,0</sub>), S<sub>0</sub> = 1 m<super>2</super> (ISO/TS 7849-1:2009 Ec. 12, -2:2009 Ec. 15), con el nivel de velocidad superficial L<sub>v</sub> = 20 lg(v/v<sub>0</sub>), v<sub>0</sub> = 5&#183;10<super>&#8722;8</super> m/s (Ec. 3) y el término de impedancia fijo 10 lg(Z<sub>c,n</sub>/Z<sub>c,0</sub>) = 10 lg(411/400) = 0,12 dB.",
