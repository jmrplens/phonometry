...
disturbances have to be kept out of it. None of that is arithmetic and none of
it is here. What is here is the instrument the two parts describe between
them, and the quantities it is required to produce.
...
**No measurement procedure.** Transducer coupling, measurement positions,
measurement duration and the treatment of disturbances are DIN 45669-2, and
the assessment of what was measured is DIN 4150-2 and DIN 4150-3.
