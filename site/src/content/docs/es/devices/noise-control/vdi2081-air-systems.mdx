...
Un silenciador de bafles no es uno de estos: su pérdida por inserción viene de
...
- [Silenciadores](/phonometry/es/devices/noise-control/silencers/): qué está
  haciendo un silenciador de bafles y cómo se mide su pérdida por inserción.
