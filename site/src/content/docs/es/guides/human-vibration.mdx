...
análisis de la exposición por operación (el valor total de vibración $a_{hv}$ o
$a_v$ de cada operación, su tiempo de exposición diario $T_i$ y la exposición
parcial $A_i(8)$, cerrado por el total diario y el $A(8)$ combinado) con el
gráfico de aportes, y el $A(8)$ recuadrado con su zona de exposición.
