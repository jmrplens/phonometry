...
says which number on a sheet is which. A manufacturer's table pasted into an
issue or a pull request is never merged, and nothing on this page comes from
one.
