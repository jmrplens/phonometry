...
Cada fila lleva las tres velocidades longitudinales, imprimiera la suya la que
imprimiera, así que la comparación es entre dos libros y no entre dos ondas. La
