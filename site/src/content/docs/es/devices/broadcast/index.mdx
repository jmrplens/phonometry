...
uno del otro. Aquí es una **medida energética**: un valor cuadrático medio ponderado
...
del paso alto RLB —, el valor cuadrático medio en bloques de 400 ms con 75 % de
