...
thickness $d$, test facility, climate), a metrics table (the resonant frequency
...
nearest MN/m³; `language="es"` renders the Spanish fiche. It needs the report
extra (`pip install phonometry[report]`).
