...
the fixed disclaimer. It uses the same `ReportMetadata` container and rendering
engine as the [ISO 717 insulation fiche](/phonometry/guides/insulation-field/#iso-717-report-report);
