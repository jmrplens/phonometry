...
arriba), y el límite superior lo fija la absorción del aire. La fuente en ensayo no debe
...
| `temperature_c` | float | °C | por defecto `23.0` | Fija $c$, $C_1$, $C_2$ |
...
static_pressure_kpa=101.325)` toma los mismos niveles de cámara más los niveles
de la fuente de referencia y su potencia conocida.
...
| `temperature_c`, `static_pressure_kpa` | float | °C, kPa | por defecto `23.0`, `101.325` | Fijan $c$, $C_1$, $C_2$ como en la sección 1 |
