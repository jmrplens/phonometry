...
50 mm de canto como mucho, con un paso de 0,6 m; soportes de 50 mm por 50 mm
como mucho, separados 1,2 m por lo menos; un marco de montaje de material macizo
de 20 kg/m² o más; y una muestra que no flecte más de 5 mm en ningún punto. Los
tres que recibe la comprobación, la sección de la subestructura, la densidad del
marco y la flecha, sí se juzgan, y salirse de uno lanza un
`SuspendedCeilingWarning` que dice cuál. El paso de la subestructura y la
sección y separación de los soportes se publican como `SUBSTRUCTURE_SPACING_M`,
`SUPPORT_SECTION_MM` y `MIN_SUPPORT_SPACING_M` para construir con ellos:
describen cómo se colgó la muestra y no una medida hecha sobre ella, así que
nada en la llamada puede comprobarlos.

### Cómo se hace la medida

<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/diagram_suspended_ceiling_specimen.svg" alt="Cuatro vistas de un mismo montaje de ensayo. Arriba a la izquierda, el suelo de una cámara reverberante en planta: una muestra de diez coma ocho metros cuadrados hecha de treinta objetos de ensayo de sesenta por sesenta centímetros, cinco por seis, unidos a tope con las juntas sin sellar y sin perfilería vista encima, rodeada por un marco de montaje que cubre su perímetro, todo girado al menos diez grados respecto a las paredes y a setenta y cinco centímetros como mínimo de cualquier borde de la sala, un metro si es posible. Arriba a la derecha, las dos medidas de cuya diferencia sale la absorción: la sala vacía sin el marco, que da T1 y A1, y la sala con la muestra en su marco, que da T2 y A2, con la temperatura y la humedad comprobadas en cada una, sobre unas notas que piden una humedad relativa de al menos el cincuenta por ciento con el humidificador apagado al medir, la sala vacía medida al menos una vez al día en condiciones estables y otra vez el mismo día si la corrección del aire pasa de cero coma cero cinco, y ningún plano de micrófonos paralelo a una superficie de la sala. Abajo a la izquierda, una sección del montaje de tipo E apoyado cara arriba sobre el suelo, sin embutir en él, como exige el marcado CE: un marco macizo de al menos veinte kilogramos por metro cuadrado sellado al suelo, la cara vista enrasada con su borde superior y la junta cubierta con cinta, doscientos milímetros de profundidad total desde el suelo hasta la cara, perfiles de subestructura de treinta milímetros de ancho y cincuenta de alto como mucho, a unos sesenta centímetros entre ejes, sobre soportes de cincuenta por cincuenta milímetros como mucho, una cámara de aire cerrada sin tabiques y una flecha de cinco milímetros como mucho en cualquier punto, bajo una nota que advierte de que la posición cara arriba solo vale si la gravedad no cambia la absorción, y de que un relleno poroso suelto se sujeta a la placa con una malla de alambre de dos milímetros como mucho y retícula de unos cien milímetros. Abajo a la derecha, la subestructura vista desde abajo, con los perfiles en una sola dirección a unos sesenta centímetros y sus soportes a un metro veinte como mínimo entre sí. Un recuadro al pie lleva el coeficiente de absorción como A2 menos A1 entre S, con S tomada sobre los objetos de ensayo, y la corrección por absorción del aire, cuatro V por m2 menos m1 entre S, con su valor absoluto limitado a cero coma cero cinco en cada banda, y la nota de que la incertidumbre de la tabla 1 vale solo para este montaje" width="100%" />
...
subestructura dentro de la sección de 30 mm por 50 mm, y comprueba la flecha en el
...
medidas: la corrección de abajo es la diferencia entre ellas, y es una diferencia
...
- **EN 16487:2014**: la geometría de muestra de 4.1.1.1, los cuatro montajes de
  ...
  subestructura y flecha de 4.1.1.2.3.4 y 4.1.1.2.3.5, la corrección por absorción
  del aire y su tope de 4.2.1, la humedad de 4.2.2, y la tabla 1 con su factor de
  cobertura.
