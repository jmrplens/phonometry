...
z = [0.0, 1000.0]
c = [1490.0, 1507.0]                        # linear gradient_per_s, g = 0.017 1/s
...
# the launch angle and the gradient_per_s are left,
...
print(round(float(arr.launch_angles_deg[1]), 2))            # -9.31 degrees: up
...
print(beams.launch_angles_deg.size)                # 439 beams over +-45 degrees
