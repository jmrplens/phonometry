...
<video class="light-only" src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/anim_instantaneous_intensity_es.webm" autoplay loop muted playsinline role="img" aria-label="Animación: intensidad instantánea p por u para una onda progresiva (siempre positiva, media no nula, fluye potencia neta) frente a una onda estacionaria (oscila en torno a media cero, la energía solo chapotea)" style="width:88%"></video><video class="dark-only" src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/anim_instantaneous_intensity_es_dark.webm" autoplay loop muted playsinline role="img" aria-label="Animación: intensidad instantánea p por u para una onda progresiva (siempre positiva, media no nula, fluye potencia neta) frente a una onda estacionaria (oscila en torno a media cero, la energía solo chapotea)" style="width:88%"></video>
