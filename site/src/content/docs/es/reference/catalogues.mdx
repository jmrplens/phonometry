...
específicos, que entre las dos fijan todos los estados en los que puede estar.
`fluids.PUBLISHED_GASES` guarda esas dos columnas, y `Gas.ideal_state` va de
ellas al estado que se le pida, llevándose la página junto con el número. El
