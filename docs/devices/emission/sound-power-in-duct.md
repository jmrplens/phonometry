...
$c$ that `temperature_c` gives, up to 0.08 dB away over the range of
...
| `temperature_c` | float | °C | −50 to 70, default `20.0` | Duct air; sets $c$ and $\rho$, and with them the $c$ of Eq. 8 for the omni-directional shields |
| `static_pressure_kpa` | float | kPa | default `101.325` | Duct air; sets $\rho$ |
