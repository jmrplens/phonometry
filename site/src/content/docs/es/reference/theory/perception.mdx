...
0,47/0,53, también apartado 6.3) preceden a la salida de sonoridad frente al
tiempo a 500 Hz (apartado 6.3) y a los percentiles N5/N10 (apartado 6.4).
...
La agudeza (*sharpness*) condensa en un solo número el énfasis en alta frecuencia de un sonido: el primer momento ponderado por $g(z)$ del patrón de sonoridad específica estacionaria de ISO 532-1 (DIN 45692:2009-08, Ecuación 1):
