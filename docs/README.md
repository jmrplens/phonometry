...
- [Hearing protectors](perception/hearing/hearing-protectors.md): the ISO 4869-1 attenuation on sixteen subjects with its uncertainty and significance test, and the ISO 4869-2 octave-band, HML and SNR methods that turn it into the effective A-weighted level left at the ear
