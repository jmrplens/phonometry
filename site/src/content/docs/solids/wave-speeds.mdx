...
solve. `PUBLISHED_SOLIDS` holds seventy-eight rows read from three published tables, keyed
...
Three tables print a steel, at the same density, and they are not the same
