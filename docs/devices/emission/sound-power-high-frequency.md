...
describes a circle at least 2 m across, mounted pointing upwards so that its
diaphragm faces away from the equipment (clause 5.4): that orientation is what
keeps the direct field out of a reading that the method treats as purely
reverberant. The equipment stands on the floor at least 1 m from any wall and
...
[`sound_power_pressure`](sound-power-pressure.md)
