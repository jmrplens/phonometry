...
Dos reglas mantienen eso honesto, y la biblioteca hace cumplir las dos. Los
puntos medidos tienen que caer a menos de 3 dB de la recta, porque más allá
de eso los niveles no son una recta en esa variable y leer la recta no
significa nada. Y la recta se puede prolongar hasta la mitad del régimen más
pequeño medido y hasta el doble del mayor, y no más, que para estos cinco
puntos son de 0,025 a 1,6 m³/s. Pedir un nivel fuera de ahí lo dice:
