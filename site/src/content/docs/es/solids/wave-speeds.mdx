...
Cuatro de las seis tablas imprimen un acero, y no son el mismo acero:
Hopkins da una velocidad de placa de 5 270 m/s y un Poisson de 0,28, Cremer un
módulo de 210 GPa y 0,31, y Mechel un módulo de 200 GPa y ningún Poisson. Un
...
Dos de las seis tablas imprimen una velocidad longitudinal y un factor de
pérdidas sin decir cuál de cada uno es. La columna de Long se titula «Speed of
Longitudinal Waves» y a su lado no hay ni módulo ni coeficiente de Poisson, así
que nada de la página puede decidir si es la de barra, la de placa o la de
sólido extenso.
...
Compararla con las cuatro tablas que sí lo dicen apunta a la de barra: 5 050 m/s
queda por debajo de todas las velocidades de placa del catálogo, y el aluminio
de Long coincide al dígito con la velocidad de barra que imprime Bies. Eso es
