...
description: "El sonido en exteriores y las fuentes que lo dominan: el modelo de propagación ISO 9613, el nivel de evaluación de ISO 1996 y su aplicación española, el ajuste por sonidos impulsivos NT ACOU 112, los modelos de fuente CNOSSOS-EU de carretera y ferrocarril y de aerogeneradores de IEC 61400-11, y el método estadístico de paso de la ISO 11819-1, que califica un pavimento."
---
