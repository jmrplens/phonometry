...
norma se describe en vez de calcularse: el criterio de linealidad del apartado
7.6 (dos espectros de entrada separados 10 dB que coincidan dentro de 1,5 dB). Por último, aquí no se diseña ningún
