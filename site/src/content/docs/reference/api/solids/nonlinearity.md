...
### SolidNonlinearity.from_printed()

*classmethod*

```python
SolidNonlinearity.from_printed(**cells: Any) -> Self
```
...
### SolidNonlinearity.printed_fields()

```python
SolidNonlinearity.printed_fields() -> dict[str, Any]
```
