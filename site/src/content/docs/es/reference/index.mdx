...
## [Catálogos publicados](/phonometry/es/reference/catalogues/)

Los valores de material y de fluido que la biblioteca lee en vez de calcular,
en una tabla por catálogo: constantes elásticas, parámetros de porosos y
estados de fluido, y cada fila nombra el libro, la tabla, la página del PDF y
el folio impreso en los que se leyó. Lo que decía la celda se conserva tal
cual lo decía, así que un intervalo sigue siendo un intervalo, una cota sigue
siendo una cota y un valor deducido por la biblioteca a partir de otros dos
aparece marcado como deducido. Léelo cuando un número de tu cálculo necesite
fuente, o cuando quieras ver cuánto se separan los libros entre sí sobre el
mismo material.
