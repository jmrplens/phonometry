...
description: "The elastic constants of a solid and the three longitudinal wave speeds that follow from them: which one a printed table holds, how to get from one to another, and why the distinction is worth a package of its own."
---
...
- [Wave speeds](/phonometry/solids/wave-speeds/): the three longitudinal
