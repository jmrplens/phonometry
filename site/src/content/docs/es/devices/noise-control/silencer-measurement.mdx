...
<Video
  ...
  width={2400}
  height={1350}
  title="La boca de un conducto en una simulación FDTD 2D"
  description="Un conducto de 0,20 m enrasado en una pantalla rígida, radiando al semiespacio que hay más allá, excitado a 100 Hz y a 800 Hz uno sobre otro. A 100 Hz el conducto se llena de onda estacionaria y sólo escapa un campo débil al otro lado de la pantalla; la envolvente que hay al lado oscila entre un máximo y un mínimo que dan un coeficiente de reflexión de 0,71. A 800 Hz el conducto lleva una onda casi viajera y de la boca salen frentes circulares fuertes hacia el semiespacio, con una envolvente que apenas ondula y da 0,19."
/>
