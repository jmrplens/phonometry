...
### NonlinearityParameter.from_printed()

*classmethod*

```python
NonlinearityParameter.from_printed(**cells: Any) -> Self
```
...
### NonlinearityParameter.printed_fields()

```python
NonlinearityParameter.printed_fields() -> dict[str, Any]
```
