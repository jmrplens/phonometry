...
description: "Rating environmental noise once it has arrived: the ISO 1996-1 indicators and rating level, the ISO 1996-2 determination chain with its residual correction and uncertainty budget, the impulsive-sound adjustment, the statistical distribution of a blast's sound exposure level, a national application of the whole chain, and the soundscape analysis of ISO/TS 12913 that asks how the people there hear it."
---
