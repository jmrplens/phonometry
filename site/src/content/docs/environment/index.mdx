...
description: "Sound outdoors and the sources that dominate it: the ISO 9613 propagation model, the ISO 1996 rating level and its Spanish application, the NT ACOU 112 impulsive-sound adjustment, the ISO 13474 distribution of a blast's sound exposure level, the ISO/TS 12913 soundscape analysis, the CNOSSOS-EU road and railway and IEC 61400-11 wind-turbine source models, and the ISO 11819-1 statistical pass-by that rates a road surface."
---
