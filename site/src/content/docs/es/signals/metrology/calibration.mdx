...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `level` | 5.3.2 | nivel generado menos nivel especificado, media de tres acoplamientos | Tabla 2 | Tabla A.1 | ±0,25 dB; 0,15 dB |
...
Cada uno se juzga con la regla de conformidad que ya comparten todas las normas
del IEC TC 29 (5.1.15): la desviación dentro de su límite de aceptación **y** la
incertidumbre dentro de su máximo, ambos inclusive. La regla por sí sola es
...
discontinua o antes. Aquí una lectura ambiental, 0,28 dB frente a 0,25 dB, es
todo el veredicto.*
