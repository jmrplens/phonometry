...
description: "Los descriptores de fuente de los que parte una predicción ambiental: la emisión de carretera y ferrocarril de CNOSSOS-EU según el Anexo II de la Directiva 2002/49/CE, el método estadístico de paso de la ISO 11819-1 que mide lo que añade un pavimento, y la potencia acústica aparente y la audibilidad tonal de un aerogenerador según IEC 61400-11."
---
...
derecho propio y no un paso preliminar. Lo que produce cada página de emisión
de aquí es ese descriptor, en la forma que consume
...
2,5 a 3,5 dB(A) más ruidosa que la de 2015: cualquier comparación con
...
[Ruido y pavimento: el método estadístico de
paso](/phonometry/es/environment/sources/road-surface-pass-by/)
es la única página de aquí que mide lo que aporta un **pavimento** en lugar de
lo que emite una fuente. La ISO 11819-1 registra el nivel máximo y la velocidad
de turismos y pesados aislados, ajusta cada categoría con una recta en el
logaritmo de la velocidad, la lee a las velocidades de referencia de su tabla 1
y suma los tres niveles sonoros de vehículo en el índice estadístico de paso,
que en muchos casos se da como diferencia con un pavimento de referencia.
...
ferrocarril reutiliza. La de aerogeneradores es independiente de ambas, y
también lo es la del método estadístico de paso, que no alimenta ningún modelo
de propagación: su índice ordena pavimentos.
...
- [Ruido y pavimento: el método estadístico de paso](/phonometry/es/environment/sources/road-surface-pass-by/):
  la regresión de la ISO 11819-1 de cada categoría de vehículo frente a la
  velocidad, los niveles sonoros de vehículo a las velocidades de referencia de
  la tabla 1, el índice y su diferencia con un pavimento de referencia.
- [Emisión de la fuente ferroviaria CNOSSOS-EU](/phonometry/es/environment/sources/cnossos-rail-emission/):
