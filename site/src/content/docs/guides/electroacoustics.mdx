...
- [Swept-sine distortion](/phonometry/guides/swept-sine-distortion/): the
  ...
  distortion panel.
- API reference: [`electroacoustics.distortion`](/phonometry/reference/api/electroacoustics/distortion/), [`electroacoustics.frequency_response`](/phonometry/reference/api/electroacoustics/frequency-response/), [`electroacoustics.piston`](/phonometry/reference/api/electroacoustics/piston/) and [`electroacoustics.loudspeaker`](/phonometry/reference/api/electroacoustics/loudspeaker/).
