...
beyond $r_c$. The building blocks are exposed individually, so an emission
...
**Where the statistics stop.** Below the **Schroeder frequency**
$f_s = 2000\sqrt{T/V}$ (V in m³, T in s) the room field is ruled by discrete
modes and the diffuse assumptions of $R$ and $r_c$ fail; above it modes overlap
and this statistical picture holds.
