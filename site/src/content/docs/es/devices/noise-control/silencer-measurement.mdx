...
Dos normas describen la medida y sólo se diferencian en cuánto le exigen al
laboratorio. La **ISO 7235:2003** es el procedimiento completo, con un filtro
modal que desacopla la fuente, un lado receptor cualificado y una
incertidumbre de medida declarada; cubre silenciadores, unidades terminales de
aire y otros elementos de conducto, con flujo y sin él. La **ISO 11691:1995**
es el método de laboratorio de clase de precisión 3 sin flujo, seis páginas
impresas con dos ecuaciones, para silenciadores cuya velocidad de diseño no
pasa de 15 m/s.
...
límite se describen pero no se calculan. La mitad con flujo de la ISO 7235 no
está en esta página: el ruido de flujo del 6.4, el caudal volumétrico y el
coeficiente de pérdida de presión del 6.5, y la pérdida por transmisión en la
boca del anexo B son trabajo aparte. Tampoco está la ISO 11820, que mide un
