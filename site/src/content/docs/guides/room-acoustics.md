...
<img class="light-only" src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/diagram_sti_chain.svg" alt="Measurement chain: an excitation signal plays through the room to a microphone, and deconvolution recovers the impulse response" style="width:92%"><img class="dark-only" src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/diagram_sti_chain_dark.svg" alt="Measurement chain: an excitation signal plays through the room to a microphone, and deconvolution recovers the impulse response" style="width:92%">
