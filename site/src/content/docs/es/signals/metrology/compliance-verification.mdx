...
aceptación en ese techo (IEC 60942, Anexo D; IEC 61672-1, Anexo A), así que un
laboratorio que respeta su máximo no puede dar por bueno un instrumento fuera
de su tolerancia. Los dos límites son inclusivos: una desviación igual a su
...
e1 = [metrology.verify_conformance(d, uncertainty=u, acceptance_limits=0.25,
...
absoluta, así que sus ejemplos toman un solo número (`acceptance_limits=0.25`
es ±0,25 dB); la IEC 61672-1 escribe la mayoría de los suyos como un par
asimétrico. `verify_sound_calibrator` aplica la regla a cada requisito de la
