...
dice qué son los números de una hoja de características o de un informe de
ensayo: el coeficiente práctico frente al de tercios de octava, un nivel
declarado con marcado CE frente a una medida, el montaje y la revisión; y
enseña a guardarlos, con el índice de reducción acústica de un laboratorio y
la mejora a impactos de un revestimiento, en un catálogo propio que los
vuelve a valorar a partir de sus bandas.
...
Si vienes buscando un número y no un método, la página de
[catálogos publicados](/phonometry/es/reference/catalogues/) tiene todos los
valores que esta biblioteca lee de una página impresa, una tabla por catálogo,
con el libro y la página en que se leyó cada fila.
