...
references:
  ...
  - type: standard
    ...
    note: "Clause 5, the single-number rating DLalpha and its 0,99 ratio limit; Clause 6.1, reporting to the nearest integer; Annex A, the A1 to A5 categories. Read from the BS EN 1793-1:2012 edition."
  - type: standard
    organization: "European Committee for Standardization"
    year: 2012
    ...
    note: "Clause 5.2, the single-number rating DLR; Clause 7.1, reporting to the nearest integer; Annex A, the B1 to B4 categories. Read from the BS EN 1793-2:2012 edition."
  - type: standard
    organization: "European Committee for Standardization"
    year: 1997
    ...
    note: "Table 1, the eighteen relative A-weighted one-third octave band levels both single-number ratings are weighted by. Read from the BS EN 1793-3:1998 edition."
---
...
grassland above sits at $X = 3.8\times10^{-4}$ at 63 Hz and 0.024 at 4 kHz;
the asphalt curve of the figure never enters the range at all. Below the range the
...
A row of `environment.PUBLISHED_GROUND`, or of [a catalogue of your own](/phonometry/io/material-catalogues/),
...
- [Published catalogues](/phonometry/reference/catalogues/#ground-surfaces): the
