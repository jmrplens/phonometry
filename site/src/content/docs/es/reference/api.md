...
| `verify_filter_class` | `función` | **Verificación de clase IEC 61260-1:2014.**<br>• `bank`: un `OctaveFilterBank`<br>• `worn`: puntos de frecuencia por banda (def.: 32768) | `result = verify_filter_class(bank)`<br><br>• `result["overall_class"]`: 1, 2 o None<br>• `result["bands"]`: clase y márgenes por banda [dB] |
