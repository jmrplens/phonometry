...
solve. `PUBLISHED_SOLIDS` holds one hundred and eighty-three rows read from four published tables, keyed
...
Three of the four tables print a steel, and they are not the same
