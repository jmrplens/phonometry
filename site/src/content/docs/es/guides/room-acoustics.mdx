...
references:
  ...
  - type: standard
    ...
    note: "Los grados de precisión, los recuentos de posiciones y la distancia mínima a la fuente de la discusión sobre promediado del §1."
  - type: standard
    organization: "International Organization for Standardization"
    year: 2012
...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/schroeder_decay_es.png" alt="Respuesta al impulso al cuadrado con su curva de decaimiento integrada hacia atrás de Schroeder, y las ventanas de regresión EDT, T20 y T30 marcadas" width="80%" />
