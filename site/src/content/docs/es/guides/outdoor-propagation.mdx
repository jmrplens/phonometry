...
(dibujada en dB/km, la unidad de la Tabla 1). Pasar una `distance` también
registra la atenuación total $A = \alpha\,d$ sobre ese trayecto como
`total_attenuation`, el $A_{atm}$ de la ISO 9613-2 (Ec. (8)).
...
res.plot()   # alpha en dB/km frente a la frecuencia (requiere matplotlib)
```

<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/atmospheric_attenuation_es.svg" alt="Coeficiente de atenuación atmosférica de tono puro alfa de la ISO 9613-1 en dB/km frente a la frecuencia en un eje log-log para la atmósfera de referencia de 20 grados Celsius y 50 por ciento de humedad relativa, producido por el método plot del resultado AtmosphericAttenuation" width="80%" loading="lazy" />

*En la atmósfera de referencia de 20 °C / 50 % HR $\alpha$ sube desde bastante
menos de 0,1 dB/km a 50 Hz hasta más de 100 dB/km a 10 kHz, con el crecimiento
$f^2$ doblándose a través de la región de relajación.*
