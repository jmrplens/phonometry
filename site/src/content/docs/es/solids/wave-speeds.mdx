...
velocidades. `PUBLISHED_SOLIDS` tiene doscientas diecinueve filas leídas de seis tablas
...
Cuatro de las seis tablas imprimen una fila llamada Steel, y no son el mismo
...
uno por ciento de carbono, y Long una velocidad y una densidad y ningún módulo.
...
Long no imprime módulo, y por eso el bucle pregunta si lo hay antes de dividir.
...
estar describiendo otro material. En estas seis tablas la densidad de un
material con nombre concuerda dentro del 2,6 por ciento, siempre, mientras que
los módulos discrepan un diecinueve por ciento en el aluminio y un treinta en
el plomo sin que nadie se equivoque. Así que una densidad a más del 8 por
ciento es una errata de transcripción, y un módulo que dobla al vecino es la
literatura.

La primera pasada completa encontró el estaño, donde tres libros no se ponen de
...
transversal; los 54 de Bies reproducen exactamente sus 2 720 m/s impresos; y el
`h f_c` de 81 m Hz de Mechel sale de 4,4 y no de 54. Ninguna página se
contradice a sí misma, así que esto no es una errata que registrar, y el módulo
aceptado del estaño anda cerca de la cifra de Bies y no de la que comparten los
otros dos. Que dos libros coincidan no es prueba, y por eso el catálogo se
queda con los seis y nada en él vota por mayoría.
