...
- [Aircraft noise: Effective Perceived Noise Level](aircraft-noise.md) — the ICAO Annex 16 Vol. I Appendix 2 EPNL (perceived noisiness and PNL, the tone correction by the slope method, and the 10 dB-down duration correction), the IEC 61265 measurement-system verifier, and the SAE ARP 5534 one-third-octave-band atmospheric absorption (SAE Method)
