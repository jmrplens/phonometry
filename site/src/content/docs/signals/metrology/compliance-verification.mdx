...
effective bandwidth and the summation of adjacent outputs, all class 1. The
decimated octave bank is the one that parts company with its Table 1 verdict,
class 2 on the summation, and
...
shows why. A margin of +0.400 dB on a passing Butterworth bank is the passband
