...
[Descenso espacial del sonido en locales de
trabajo](/phonometry/es/buildings/rooms/workroom-sound-decay/)
hace en cambio la pregunta que plantea una nave industrial: no cuánto dura un
decaimiento, sino cuánto cae el nivel al alejarse de una máquina, y cuánto por
encima del aire libre está la sala mientras lo hace.
...
- [Descenso espacial del sonido en locales de trabajo](/phonometry/es/buildings/rooms/workroom-sound-decay/):
  la curva de distribución espacial del sonido de un local de trabajo con sus
  dos descriptores, la corrección del anexo B para la curva propia de la fuente,
  y las categorías de predicción y niveles de detalle que las emparejan en
  proyecto.
