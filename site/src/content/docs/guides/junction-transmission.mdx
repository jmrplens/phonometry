---
title: "Bending-wave transmission at plate junctions (Cremer / Craik / Hopkins)"
...
reduction index** (Eq. 5.116) `Kij = 10 lg(1 / tau_ij) + 5 lg(fc_j / fc_i)`,
which for identical plates reduces to `Kij = 10 lg(1 / tau_ij)` -- for the
