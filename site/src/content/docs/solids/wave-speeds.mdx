...
Four of the six tables print a steel, and they are not the same
steel: Hopkins gives a plate speed of 5 270 m/s and a Poisson ratio of 0,28,
Cremer a modulus of 210 GPa and 0,31, Mechel a modulus of 200 GPa and no
Poisson ratio at all. A flat `"steel"` would have to pick one of them without
