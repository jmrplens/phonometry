...
(transmissibility) methods, and their low-frequency stiffness by the
driving-point method, one value per one-third-octave band.
...
- [Transfer stiffness of resilient elements (ISO 10846)](transfer-stiffness.md):
  dynamic transfer stiffness of isolators by the direct, indirect and
  driving-point methods, in one-third-octave bands, with the checks of the rig.
- [Vibration damage to structures (DIN 4150-3)](structural-damage.md):
...
On the isolator page, one of the standard's own validity checks is described
rather than computed: the linearity test (two input spectra 10 dB apart
must give transfer-stiffness levels within 1.5 dB, clause 7.7 of ISO 10846-2, -4 and -5 and clause 7.6 of
ISO 10846-3). Finally, nothing here
