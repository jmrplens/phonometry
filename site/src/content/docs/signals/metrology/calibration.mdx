...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `level` | 5.3.2 | generated minus specified level, the mean of three couplings | Table 2 | Table A.1 | ±0.25 dB; 0.15 dB |
...
within its maximum, both inclusive. The rule on its own is
...
measurement conforms when both bars stop at or before the dashed line. Here one
