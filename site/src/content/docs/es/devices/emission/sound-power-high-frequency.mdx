...
erratas del párrafo siguiente: todas son celdas cuyo cuarto decimal es 0,
impreso como otra cifra.*
...
impresas, y de la misma manera: el anexo A da 0 como cuarto decimal y la página
imprime otra cifra, casi siempre el tercer decimal repetido («0,027 7» donde
el anexo A da 0,027 0). La mayor es «0,033 0» por 0,030 0 a 14 500 Hz, 25 °C y
