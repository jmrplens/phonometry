---
title: "Theory"
description: "Standards, math and design decisions behind PyOctaveBand."
---
...
oversampled rate (≥ 96 kHz) — see [Frequency Weighting](/PyOctaveBand/guides/weighting/).
...
mean-square output state. See [Why PyOctaveBand](/PyOctaveBand/reference/why-pyoctaveband/) for the
