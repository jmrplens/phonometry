...
`N5/N95`; and the ECMA-418-2 tonality, roughness `R10`, `R50` and fluctuation
...
- [Errata in published sources](../../ERRATA.md): part 3 for part 2, the stray
  factor of Formula (A.3), three scales for four, and the questionnaire
  misspellings.
