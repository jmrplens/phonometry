...
print(octaves.frequencies)                             # ~[126, 251, 501, 1000, 1995, 3981]
...
ax.set_xticklabels([f"{f:g}" for f in octaves.frequencies])
...
Returns a `RoomAcousticsResult`: `frequencies` (band centres, or `None`
