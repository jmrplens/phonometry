...
description: "Los tres métodos de la ISO 4869-2 que convierten la atenuación medida de un protector auditivo en el nivel efectivo ponderado A: el método por bandas de octava, los valores HML y el índice de número único, los tres con un mismo rendimiento de protección."
references:
  - type: standard
  ...
  - type: standard
    ...
    note: "De dónde salen las atenuaciones por sujeto: la atenuación en oído real en el umbral, medida sobre 16 sujetos, que es la entrada de la que parte todo método de esta página."
---
