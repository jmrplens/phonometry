...
the ISO 13474 distribution that says how often a distant blast is heard at
each sound exposure level as the weather between source and receiver changes,
and the ISO/TS 12913 soundscape analysis that asks the people there how they
hear it.
...
- [Soundscape Analysis (ISO/TS 12913)](assessment/soundscape.md):
  how the people there hear it: the questionnaire and its scale values, the
  pleasantness and eventfulness of each site, their correlation with the
  measured levels and the binaural metrics at both ears.
