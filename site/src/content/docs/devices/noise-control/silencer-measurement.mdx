...
and the settling length of 6.5.2.2.1.
</ScopeClaim>
...
piezometric ring are procedure rather than arithmetic, and the extrapolation
of a measured coefficient outside the range it was measured over is left to
the reader.
