...
efectivo y la suma de salidas tal como los ensaya IEC 61260-2, el ensayo de
invariancia en el tiempo con barrido, la clase 0 más estricta de la edición
retirada de 1995, qué aporta una clase de prestaciones en una medida y la ficha
de conformidad acreditada de una página. La misma guía califica los resultados
de los ensayos periódicos de IEC 61260-3 de un laboratorio.
...
- [Galería de arquitecturas de filtro](/phonometry/es/signals/filters/filter-gallery/):
  ...
  cada arquitectura.
- [Verificación de clase de filtros (IEC 61260-1)](/phonometry/es/signals/filters/filter-compliance/):
  la máscara de aceptación de la Tabla 1, el ancho de banda efectivo, la suma
  y el ensayo con barrido, la calificación de los ensayos periódicos, la
  clase 0 y la ficha de conformidad.
...
Tabla 1 de IEC 61260-1 y califica sobre ella el ancho de banda efectivo (5.12)
y la suma de salidas (5.16) tal como los calcula IEC 61260-2, y
`verify_time_invariance` pasa el ensayo con barrido del 5.14 por el propio
banco; un veredicto de clase de aquí es una afirmación sobre el diseño y no
sobre un aparato. Los ensayos que IEC 61260-2 e IEC 61260-3 hacen sobre un
filtro físico (sobrecarga, linealidad, ruido propio, las magnitudes de
influencia ambientales) necesitan el instrumento en un laboratorio y aquí no se
ejecutan; `verify_filter_periodic` califica los resultados que un laboratorio
trae de los ensayos periódicos, y dice lo que no pueden demostrar. Cerca de Nyquist la transformada bilineal deforma el eje de
