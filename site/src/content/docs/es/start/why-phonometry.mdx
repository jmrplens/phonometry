...
| IEC 60942:2017 Tablas 2 a 7, A.1 a A.5 y E.1 | Límites de estabilidad a corto plazo del calibrador por clase y frecuencia en `sensitivity()`, y cada requisito que califica `verify_sound_calibrator()` | `tests/metrology/test_calibration_validation.py`, `tests/metrology/test_sound_calibrator.py` |
