...
fila. Todas las magnitudes se convirtieron de los grados Fahrenheit y las
libras por pulgada cuadrada que imprime la página, así que cada celda va
marcada como calculada y no como leída, y dice de qué se calculó. La página
...
describe en vez de nombrarse: una docena larga empiezan por `Igual que 1 salvo
que`, y la fila a la que remiten está a una consulta. Todas las dimensiones van
impresas dos veces, en centímetros y en pulgadas, y diecinueve de los
trescientos veinte pares no son el mismo número. Constan en las erratas del
