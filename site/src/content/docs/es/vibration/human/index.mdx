...
**Un vibrómetro se juzga por su ponderación.** Las tablas de tolerancia de la
ISO 8041-1 están implementadas, así que una respuesta de ponderación medida
puede contrastarse con la banda que la norma le permite, que es de lo que trata
la [verificación del
vibrómetro](/phonometry/es/vibration/human/meter-verification/). Los apartados
de diseño y ensayo de tipo de esa norma, desde la indicación y la linealidad
hasta los ensayos ambientales, son medidas de laboratorio sobre soporte físico
y quedan fuera: cumplir en la ponderación es condición necesaria para la
conformidad, no un certificado de ella.
</ScopeClaim>
