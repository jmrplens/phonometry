...
[potencia sonora](/phonometry/es/guides/sound-power/) de una fuente con el nivel
...
Cuando una fuente de potencia sonora constante funciona en una sala, el nivel se
...
más allá de $r_c$. Los bloques se exponen por separado, de modo que una medición
...
**Dónde acaba la estadística.** Por debajo de la **frecuencia de Schroeder**
$f_s = 2000\sqrt{T/V}$ (V en m³, T en s) el campo de la sala lo gobiernan modos
discretos y fallan los supuestos difusos de $R$ y $r_c$; por encima los modos se
solapan y esta imagen estadística se cumple.
...
- [Potencia sonora](/phonometry/es/guides/sound-power/): el `Lw` que impulsa el
  nivel estacionario.
