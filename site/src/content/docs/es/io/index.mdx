...
JSON tuyo, con la procedencia del documento: su tipo, su versión, el día en
...
- [Tus propios catálogos](/phonometry/es/io/material-catalogues/): una
  ...
  como plantilla, el documento y su procedencia, los rechazos que señalan
  una celda, las filas en los modelos y en todas las búsquedas por nombre,
