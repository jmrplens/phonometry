...
Una determinación de potencia acústica termina en un *documento*. Tanto el
...
`report_id`, `notes`); el área de la superficie de medición $S$ y las
correcciones $K_1$/$K_2$ proceden del propio resultado y se imprimen en el
recuadro y en la tira de base. Indicar `requirement` añade un veredicto
...
nivel promedio energético $L_p'$ y las columnas de corrección $K_1$/$K_2$ a la
tabla, y `language="es"` genera la ficha en español con decimales de coma.
