...
velocidades. `PUBLISHED_SOLIDS` tiene ciento ochenta y tres filas leídas de cuatro tablas
...
Tres de las cuatro tablas imprimen un acero, y no son el mismo acero:
