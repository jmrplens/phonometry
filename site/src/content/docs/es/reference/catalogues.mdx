...
dice qué número de una hoja es cuál. Una tabla de un fabricante pegada en una
issue o en una pull request nunca se incorpora, y nada de esta página sale de
una.
