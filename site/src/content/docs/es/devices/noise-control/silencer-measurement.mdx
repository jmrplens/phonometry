...
una pared retiene 11 dB a 63 Hz y nada en absoluto a 2 kHz:
...
de la ISO 5135. Un conducto que acaba en mitad de la sala tiene el doble de
espacio para radiar que uno enrasado, así que refleja la mitad:
...
corrección de sala en vez de deducirla. La mitad con flujo de la ISO 7235 no
está aquí: el caudal volumétrico y el coeficiente de pérdida de presión del
6.5 son trabajo aparte. Tampoco está la ISO 11820, que mide un
