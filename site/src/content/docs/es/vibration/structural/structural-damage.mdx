...
references:
  ...
  - type: standard
    ...
    note: "Dónde van los captadores de una medida en un edificio y cómo se apoyan: los puntos del cimiento del 5.1.2, las direcciones de medida del 5.2, los límites de montaje suelto del 5.3.2, el tiempo de medida del 6.1, la comprobación previa del 6.3 y la comparación con la fuente parada del 7.2.2."
---
...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/diagram_structural_damage_points.svg" alt="Sección de una vivienda de tres plantas sin sótano, con una máquina de hinca sobre el terreno a su izquierda y ondas discontinuas que van desde el pilote por el terreno hacia el edificio. Hay cuatro puntos numerados. El punto 1 es un captador en la planta más baja, en la cara interior del muro exterior orientado hacia la fuente, justo encima de la solera. El punto 2 está en el mismo muro exterior, justo bajo el forjado superior, con flechas para las dos direcciones horizontales x e y, con x saliendo del edificio hacia la fuente. El punto 3 está sobre un forjado a mitad del vano, con el vano dividido en dos mitades iguales y una flecha para la dirección vertical z. El punto 4 es una tubería enterrada dibujada en sección transversal que pasa junto al edificio, a más de 2 metros del muro exterior y acotada como tal, descubierta en un solo sitio y con un captador sobre ella. Debajo, dos detalles ampliados. El primero muestra el punto del cimiento con sus tres direcciones juntas en la cara interior del muro exterior, con x saliendo hacia la fuente, bajo una línea discontinua a 0,5 m sobre la rasante exterior. El segundo muestra la tubería a lo largo de su eje con los captadores sobre la propia tubería, z, y y x registradas y x a lo largo del eje, un punto sustituto discontinuo en el terreno de encima marcado como solo una estimación, por lo general mayor que en la tubería, y la tubería juzgada con la tabla 2 según el material. Tres recuadros al pie dicen qué se lee en cada punto del edificio: el mayor pico de las tres componentes en el cimiento, frente a la tabla 1 a la frecuencia de ese pico; el mayor pico horizontal en el plano de la última planta, frente a un valor por tipo de edificio; y una velocidad vertical de 20 milímetros por segundo o menos en el forjado, para vibración de corta duración. Las líneas de debajo dan una lectura de 5,1 milímetros por segundo a 16,5 hercios en el cimiento de una vivienda frente a los 6,6 leídos en el Bild 1, el vibrómetro y su calibración, los límites de frecuencia y aceleración de un captador apoyado sin sujeción, y cuándo se mide en varios puntos o plantas a la vez" width="100%" />
