...
medidas en `RESILIENT_LAYER_STIFFNESS`, transcritas de la tabla A3 de Hopkins
(p. impresa 610), cuyo pie dice que se midieron según la ISO 9052-1. Cada fila
lleva la página de la que se leyó, y las cuatro espumas rebond llevan la
atribución de segundo nivel que les da la celda impresa.

La clave dice de qué probeta es cada fila,
...
las separa por su posición dentro de una celda combinada.
...
print(round(layer.natural_frequency(120.0), 1))              # 45.9 Hz bajo una losa de 120 kg/m2
