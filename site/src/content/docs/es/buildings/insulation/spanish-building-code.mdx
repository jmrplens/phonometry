...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/diagram_db_hr_requirements.svg" alt="Sección de un edificio residencial de tres plantas entre una calle y una medianería, con cada exigencia del DB HR escrita sobre el elemento al que se aplica. En la calle, un coche representa el ruido de automóviles y un micrófono se sitúa a 2 m delante de la fachada para L1,2m; la fachada del dormitorio lleva D2m,nT,Atr de al menos 32 dBA, el valor de la Tabla 2.1 para un dormitorio cuando el Ld de la zona, tomado del mapa de ruido, supera 60 dBA sin pasar de 65 dBA. Dentro, la tabiquería entre un dormitorio y un salón lleva RA de al menos 33 dBA, la pared entre dos viviendas DnT,A de al menos 50 dBA, el forjado entre dos dormitorios de viviendas distintas L′nT,w de 65 dB como máximo, y el forjado sobre el local comercial de planta baja DnT,A de al menos 55 dBA bajo el dormitorio y L′nT,w de 60 dB como máximo bajo el distribuidor. La puerta del distribuidor al rellano común lleva RA de al menos 20 dBA y el cerramiento que la rodea RA de al menos 50 dBA, y la medianería admite o bien D2m,nT,Atr de al menos 40 dBA en cada hoja o bien DnT,A de al menos 50 dBA para las dos hojas juntas. Cuatro líneas bajo el terreno añaden 45 dBA para un recinto habitable, 30 dBA para una puerta compartida con un recinto protegido, 60 dBA como Ld de un área residencial sin valor oficial, Ld menos 10 dBA en una fachada no expuesta directamente al ruido y 4 dBA más en el límite donde dominan las aeronaves. Debajo, cuatro recuadros unidos por flechas siguen el anejo A: el aislamiento por bandas en dieciocho tercios de octava de 100 Hz a 5 kHz, con el índice de reducción acústica de laboratorio y las dos diferencias de niveles estandarizadas referidas a un tiempo de referencia de 0,5 s; el espectro normalizado de las tablas A.2 a A.5, que elige el ruido dominante; la suma energética de las fórmulas A.5 a A.7 para las diferencias de niveles y A.17 para RA; y el redondeo a un decimal en los cálculos y a un entero en DnT,A y L′nT,w, con 52,7 dBA que pasan a 53 dBA frente al límite de 50 dBA. Dos líneas indican que el ruido de impactos va por la curva de referencia de ISO 717-2 y que una ventana de catálogo pierde de 1 a 3 dB al crecer su área por encima de 2,7, 3,6 y 4,6 metros cuadrados, y un recuadro al pie recoge el índice: menos diez lg de la suma sobre las bandas de diez elevado al espectro menos el aislamiento, dividido entre diez" width="100%" />

*El apartado 2 sobre los elementos de un mismo edificio, de la tabiquería de
una vivienda a la medianería, y la cadena del anejo A que convierte dieciocho
bandas en el número redondeado con el que se compara cada límite de ruido
aéreo.*
