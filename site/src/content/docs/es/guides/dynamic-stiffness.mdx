...
empleada durante el ensayo, el espesor bajo carga $d$, instalación de ensayo,
...
genera la ficha en español. Requiere el extra de informes
...
res.report(
    ...
    metadata=ReportMetadata(
        ...
        mass_per_area=200.0, thickness=0.020,
        measurement_standard="EN 29052-1",
    ),
    language="es",
)   # ficha de una página (requiere phonometry[report])
```
