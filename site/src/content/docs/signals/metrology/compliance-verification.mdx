...
and no decibel margins in them: the verdict is a plain pass or fail, in the
unit its own standard writes its tolerances in.
...
| Saw-tooth burst indications | `verify_signal_burst_response` | ISO 8041-1:2017 Tables 6 to 9 | [Verifying a Human-Vibration Meter](/phonometry/vibration/human/meter-verification/) |
