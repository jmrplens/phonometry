...
`R(kz) = (kz Z − k0)/(kz Z + k0)` (Salomons Eq. H.28), transforms back and
...
[porous models](/phonometry/guides/porous-absorbers/) of the materials domain.
...
- **Homogeneous limit → spherical ground effect.** With a zero gradient the
  ...
  [`ground_effect`](/phonometry/guides/ground-barriers/) at every range, to
  about **0.1 dB** over grassland, and to the coherent **+6 dB** two-ray
  enhancement over a rigid ground.
