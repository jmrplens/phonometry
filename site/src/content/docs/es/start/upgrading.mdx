...
Lo que dibuja cada `.plot()` y lo que imprime cada `.report()` están
intactos, el contrato de `Signal` también, y lo mismo cada fórmula. La 4.0
recolocó los muebles y puso la unidad en la etiqueta; no recalculó nada.
