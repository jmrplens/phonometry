...
description: "El sonido en exteriores y las fuentes que lo dominan: el modelo de propagación ISO 9613, el nivel de evaluación de ISO 1996 y su aplicación española, el ajuste por sonidos impulsivos NT ACOU 112, la distribución de ISO 13474 del nivel de exposición sonora de una voladura, el análisis del paisaje sonoro de ISO/TS 12913, los modelos de fuente CNOSSOS-EU de carretera y ferrocarril y de aerogeneradores de IEC 61400-11, y el método estadístico de paso de la ISO 11819-1, que califica un pavimento."
---
...
su aplicación española en el RD 1367/2007, el ajuste de NT ACOU 112 que
cuantifica cuándo el carácter impulsivo hace un sonido recibido más molesto de
lo que sugiere su LAeq, la distribución de ISO 13474 que dice con qué
frecuencia se oye una voladura lejana a cada nivel de exposición sonora según
cambia el tiempo atmosférico entre la fuente y el receptor, y el análisis del
paisaje sonoro de ISO/TS 12913, que pregunta a la gente que está allí cómo lo
oye.
...
normalizado que el modelo de camino de arriba atenúa después. La ISO 11819-1
está junto a ellos y mide otra cosa: cuánto añade un pavimento al ruido del
tráfico que circula por él.
...
- [Exposición sonora de sucesos impulsivos (ISO 13474)](/phonometry/es/environment/assessment/sel-distribution/):
  con qué frecuencia se oye a cada nivel una voladura lejana: los niveles a
  largo plazo y de evaluación de su nivel de exposición sonora sobre las
  atmósferas réplica, la distribución dispersada por turbulencia y el nivel
  superado por cualquier fracción de los sucesos.
- [Análisis del paisaje sonoro (ISO/TS 12913)](/phonometry/es/environment/assessment/soundscape/):
  cómo lo oye la gente que está allí: el cuestionario y sus valores de
  escala, la agradabilidad y la eventualidad de cada lugar, su correlación
  con los niveles medidos y las métricas binaurales en los dos oídos.
...
fuente por banda, lista para que el camino de arriba la atenúe, y lo que un
pavimento añade al tráfico que circula por él.
...
- [Ruido y pavimento: el método estadístico de paso](/phonometry/es/environment/sources/road-surface-pass-by/):
  los niveles sonoros de vehículo y el índice estadístico de paso de la
  ISO 11819-1, medidos sobre tráfico real, que ordenan un pavimento frente a
  una referencia.
