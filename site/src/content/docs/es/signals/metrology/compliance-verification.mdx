...
`intensity_class_compliance` añadiendo `.plot()` y la ficha acreditada); los
cinco verificadores que califican un instrumento medido en vez de un diseño, y
...
veredicto con `.plot()` y una ficha acreditada `.report()`. Otros cinco
