...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/diagram_db_hr_requirements.svg" alt="Section through a three-storey residential building between a street and a party wall, with each DB-HR requirement written on the element it applies to. On the street a car stands for road traffic and a microphone stands 2 m in front of the facade for L1,2m; the bedroom facade carries D2m,nT,Atr of at least 32 dBA, the Table 2.1 value for a bedroom where the Ld of the zone, taken from the noise map, is over 60 and up to 65 dBA. Inside, the partition between a bedroom and a living room carries RA of at least 33 dBA, the wall between two dwellings DnT,A of at least 50 dBA, the floor between two bedrooms of different dwellings L′nT,w of at most 65 dB, and the floor over the ground-floor shop DnT,A of at least 55 dBA under the bedroom and L′nT,w of at most 60 dB under the hall. The hall door onto the common landing carries RA of at least 20 dBA and the wall around it RA of at least 50 dBA, and the party wall takes either D2m,nT,Atr of at least 40 dBA on each leaf or DnT,A of at least 50 dBA for both leaves together. Four lines under the ground add 45 dBA for a habitable room, 30 dBA for a door shared with a protected room, 60 dBA as the Ld of a residential area with no official value, Ld less 10 dBA for a facade not directly exposed to the noise and 4 dBA more on the limit where aircraft dominate. Below, four boxes joined by arrows follow Annex A: the band insulation over eighteen one-third octaves from 100 Hz to 5 kHz, with the sound reduction index from the laboratory and the two standardised level differences normalised to a reference time of 0.5 s; the normalised spectrum of Tables A.2 to A.5, picked by the dominant noise; the energy sum of Formulae A.5 to A.7 for the level differences and A.17 for RA; and the rounding to one decimal while working and to an integer in DnT,A and L′nT,w, with 52.7 dBA becoming 53 dBA against the 50 dBA limit. Two lines note that impact sound goes through the ISO 717-2 reference curve instead and that a catalogue window loses 1 to 3 dB as its area grows past 2.7, 3.6 and 4.6 square metres, and a box at the foot holds the index: minus ten lg of the sum over the bands of ten to the power of the spectrum less the insulation, divided by ten" width="100%" />

*Clause 2 on the elements of one building, from the partition inside a dwelling
to the party wall, and the Annex A chain that turns eighteen bands into the
rounded number each airborne limit is read against.*
