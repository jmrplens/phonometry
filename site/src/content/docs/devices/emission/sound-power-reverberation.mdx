...
and the upper bound is set by air absorption. The source under test must be no
...
| `temperature_c`, `static_pressure_kpa` | float | °C, kPa | defaults `23.0`, `101.325` | Set $c$, $C_1$, $C_2$ as in section 1 |
