...
los ensayos periódicos de IEC 61672-3 que recibe en servicio, y los ensayos
del propio calibrador de IEC 60942, no se ejecutan (los resultados de
laboratorio de un calibrador los califica `metrology.verify_sound_calibrator`,
que no hace ningún ensayo físico), así que un veredicto de clase de los verificadores de filtros y ponderaciones describe el algoritmo
