...
masa del suelo desnudo (`mass_per_area`, impactos), la identidad del calculista/
laboratorio (`client`, `laboratory`, `operator`, `report_id`, `test_date`) y un
resumen en texto libre de la construcción de flancos y las hipótesis del modelo
(`notes`).
