...
- **Comportamiento de la biblioteca:**
  [`DECADE_TO_DOUBLING`](../src/phonometry/room/spatial_decay.py) lleva el 0,3
  impreso, porque la constante impresa es la que reproduce los resultados
  impresos, y
  [`level_excess_at`](../src/phonometry/room/spatial_decay.py) divide entre
...
- **Comportamiento de la biblioteca:**
  [`NORMALIZED_OFFSET_DB`](../src/phonometry/room/spatial_decay.py) lleva el 6,2
  ...
  en [`tests/room/test_spatial_decay.py`](../tests/room/test_spatial_decay.py)
...
- **Comportamiento de la biblioteca:**
  [`level_excess_at`](../src/phonometry/room/spatial_decay.py) implementa la
...
- **Comportamiento de la biblioteca:** el catálogo guarda la densidad, el
  ...
  [`tests/solids/test_catalogue.py`](../tests/solids/test_catalogue.py) fijan
...
- **Comportamiento de la biblioteca:** el catálogo guarda las tres columnas tal
  ...
  [`tests/solids/test_catalogue.py`](../tests/solids/test_catalogue.py) fija
...
- **Qué hace la biblioteca:** la medida se guarda una vez en
  [`PUBLISHED_NONLINEARITY`](../src/phonometry/fluids/nonlinearity.py), y su
...
- **Qué hace la biblioteca:** en
  [`PUBLISHED_NONLINEARITY`](../src/phonometry/fluids/nonlinearity.py) las seis
...
- **Qué hace la biblioteca:** las seis filas se sirven tal como se imprimen en
  [`PUBLISHED_NONLINEARITY`](../src/phonometry/fluids/nonlinearity.py), no
...
- **Qué hace la biblioteca:** en
  [`PUBLISHED_CARPETS`](../src/phonometry/materials/absorbers/carpets.py) las
...
- **Comportamiento de la biblioteca:**
  ...
  [`tests/filters/test_time_invariance.py`](../tests/filters/test_time_invariance.py)
...
- **Comportamiento de la biblioteca:** no hace falta ninguno. La frase
  ...
  [`verify_time_invariance`](../src/phonometry/filters/time_invariance.py)
...
- **Norton & Karczub 2e (2003), apéndice 4 C, hidrógeno y oxígeno a 0 y
  ...
  `validity` en [`PUBLISHED_FLUIDS`](../src/phonometry/fluids/catalogue.py),
