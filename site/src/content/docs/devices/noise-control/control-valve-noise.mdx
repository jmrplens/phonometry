...
hydrodynamic case, where the fluid is a liquid and the sources are the
turbulence of the jet and the cavitation that joins it once the corrected
threshold is passed, is IEC 60534-8-4 and has
