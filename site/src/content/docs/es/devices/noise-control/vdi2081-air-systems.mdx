...
description: "El camino de la VDI 2081 desde el punto de trabajo de un ventilador hasta el nivel en la sala: el modelo de ventilador por tipo de montaje de la Ecuación (13), la atenuación y el ruido de flujo de cada elemento del conducto, el silenciador de láminas paralelas y su ruido propio, y el paso a la sala de la Ecuación (36), todo contra la hoja resuelta de la Tabla 1 de la Parte 2."
references:
  - type: standard
    ...
    primary: true
    note: "El método: el ventilador del apartado 4.3 con las Ecuaciones (13) y (15), la atenuación de conducto del apartado 6 con las Tablas 5 y 7, el ruido de flujo de las Ecuaciones (16), (17) y (18), el silenciador de láminas paralelas y su ruido propio de la Ecuación (49), la reflexión de boca del apartado 6.6 y el paso a la sala de la Ecuación (36). Sustituida por Blatt 1:2022-04, que no está en la biblioteca."
  - type: standard
    organization: "Verein Deutscher Ingenieure"
    year: 2005
...
Un silenciador de láminas paralelas no es uno de estos: su pérdida por inserción viene de
...
- **El ruido propio de un silenciador de láminas paralelas** (Ecuación (49)), con
  `silencer_self_noise`, que depende de la velocidad en los huecos entre láminas
  y de la pérdida de carga. Es la razón de que un silenciador tenga un tamaño
  óptimo: si se estrechan los huecos sube la pérdida por inserción, pero también
...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/vdi2081_chain_cascade.svg" alt="Niveles por bandas de octava en cinco etapas del ejemplo resuelto: en el ventilador, cerca de 90 decibelios y cayendo suavemente; tras el silenciador de láminas, que quita cuarenta decibelios de las bandas medias y deja una meseta cerca de 45 decibelios por encima de 1 kilohercio; tras la ramificación, unos decibelios menos; la potencia sonora que los dos difusores meten en la sala; y el nivel de presión sonora en el oyente, de 48 decibelios a 63 hercios a 29 a 8 kilohercios. La leyenda da el total ponderado A de cada etapa, que baja de 86 a 40 decibelios A." width="100%" />
...
- La Tabla 1 de la Parte 2 atribuye los coeficientes del silenciador de láminas
...
el ruido de flujo de las Ecuaciones (16), (17) y (18), el silenciador de láminas paralelas y su
...
- [Silenciadores](/phonometry/es/devices/noise-control/silencers/): qué está
  haciendo un silenciador de láminas paralelas y cómo se mide su pérdida por inserción.
