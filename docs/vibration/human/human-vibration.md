...
chain. Only the weighting definitions are taken from ISO 8041-1 here; what
that standard says about the instrument measuring them is
[meter verification](meter-verification.md).
