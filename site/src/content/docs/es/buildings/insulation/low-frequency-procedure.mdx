...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/diagram_low_frequency_corners.svg" alt="Cuatro paneles sobre un mismo recinto receptor de 3,6 m por 2,7 m por 2,4 m, 23 metros cúbicos al metro cúbico más próximo. Arriba a la izquierda, una planta: al otro lado del elemento separador, parte del recinto emisor con el altavoz en dos posiciones; en el recinto receptor, una zona central discontinua a medio metro de cada pared con cinco posiciones de micrófono por defecto, y cuatro micrófonos de esquina numerados del 1 al 4, las esquinas 1 y 3 a nivel de suelo y las 2 y 4 a nivel de techo, dos junto al elemento separador y dos junto a la pared del fondo. Arriba a la derecha, la esquina 2 de cerca, donde dos paredes se encuentran con el techo, con el micrófono a entre 0,3 y 0,4 metros de cada una de las tres superficies, sin que las tres distancias tengan que ser iguales, y sin muebles a menos de medio metro. Abajo a la izquierda, una sección del mismo recinto con las esquinas 1 y 3 junto al suelo, la 2 y la 4 bajo el techo, y las cinco posiciones por defecto a alturas distintas dentro de la zona central. Abajo a la derecha, la banda de 63 Hz resuelta: cuatro lecturas de esquina en cada una de las dos posiciones de fuente, la mayor de cada una, 65,1 y 65,6 dB, promediadas en energía en un nivel de esquina de 65,4 dB en lugar de la lectura suelta más alta, y combinadas después con el nivel de la zona central de 57,9 dB en un nivel de 61,9 dB que entra en la diferencia de niveles. Un recuadro al pie lleva la Fórmula (12) del nivel de esquina y la Fórmula (13) de la combinación, y cuatro líneas debajo añaden los 15 s en cada esquina, el ruido de fondo en cada esquina utilizada, el único tiempo de reverberación de la octava de 63 Hz, 0,66 s, para las tres bandas, y en qué difieren las Partes 2 y 3" width="100%" />

Usa sonómetro, filtros y calibrador de clase 0 o 1, y comprueba la cadena con
el calibrador al empezar y al terminar cada sesión; si dos comprobaciones
seguidas difieren en más de 0,5 dB, descarta lo medido desde la última
correcta. Calcula el volumen al metro cúbico más próximo: por debajo de 25 m³
las esquinas se suman a la zona central, no la sustituyen, así que mide las
posiciones por defecto como siempre, 15 s como mínimo por posición fija entre
50 Hz y 80 Hz. Después coloca el micrófono en al menos cuatro esquinas,
preferiblemente dos a nivel de suelo y dos a nivel de techo, de 0,3 m a 0,4 m
de cada una de las tres superficies y, en la Parte 1, a 1,0 m como mínimo del
altavoz, y promedia al menos 15 s. Repite la serie de esquinas en cada
posición de un único altavoz o de la máquina de impactos, al menos dos en las
Partes 1 y 2. Con la fuente apagada, mide el ruido de fondo en cada esquina
utilizada, procurando que quede más de 10 dB por debajo del nivel de señal más
fondo: entre 6 dB y 10 dB, réstalo en energía; con 6 dB o menos, aplica la
corrección de 1,3 dB y declara la banda como límite de medida. Mide un único
tiempo de reverberación, en la banda de octava de 63 Hz con al menos seis
caídas, para las tres bandas. El informe da el volumen y dice dónde se aplicó
el procedimiento.
