...
references:
  ...
  - type: standard
    ...
    note: "El vibrómetro cuyos KB_Fmax y máximos por intervalo valora esta norma, y la frecuencia de esquina de 5,6 Hz que lleva la fórmula (6). Los tres canales simultáneos y el cuarto junto a la fuente del 5.1.2, la interrupción y el borrado hacia atrás de los máximos por intervalo del 5.1.6.4, y la comprobación antes de medir del 6.5."
  - type: standard
    organization: "Deutsches Institut für Normung"
    year: 2005
    title: "Messung von Schwingungsimmissionen — Teil 2: Messverfahren"
    designation: "DIN 45669-2:2005-06"
    note: "La sección de la medida: los puntos sobre el forjado del 5.1.3, las direcciones del 5.2, los acoplamientos del 5.3.2 y el 5.3.3 con la tabla 1, el tiempo de medida del 6.1, las perturbaciones del 7.2.2 y el informe del apartado 9. Los límites del apoyo suelto, el de la cera y la carga de masa están implementados en la página del vibrómetro; el resto es texto."
---
