...
4 Hz a 315 Hz, que es donde trabaja la DIN 45672-1, y también hace falta en
voladuras y en ruido estructural.
...
fuera. Nada de eso es aritmética y nada de eso está aquí. Lo que hay aquí es el
instrumento que las dos partes describen entre las dos, y las magnitudes que se
le exige producir.
...
**Ningún procedimiento de medida.** El acoplamiento de los captadores, los
puntos de medida, la duración y el tratamiento de las perturbaciones son la DIN
45669-2, y la valoración de lo medido son la DIN 4150-2 y la DIN 4150-3.
</ScopeClaim>
